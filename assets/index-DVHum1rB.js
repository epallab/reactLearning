...
}`}),(0,k.jsx)(N,{type:`note`,title:`When to Memoize`,children:`Don't memoize everything — memoization has a cost (memory for caching, comparison overhead). Use it when: (1) a component re-renders often with the same props, (2) the render output is expensive to compute, (3) you're passing callbacks to memoized children, or (4) you have large lists that filter or sort on every render. Profile first with React DevTools Profiler, then optimize the actual bottlenecks.`}),(0,k.jsx)(`h4`,{children:`Performance Comparison Table`}),(0,k.jsxs)(Er,{headers:[`Technique`,`Level`,`What It Caches`,`When to Use`],children:[(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`blue`,children:`React.memo`})}),(0,k.jsx)(`td`,{children:`Component`}),(0,k.jsx)(`td`,{children:`Rendered output (JSX)`}),(0,k.jsx)(`td`,{children:`Component receives same props frequently and is expensive to render`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`green`,children:`useMemo`})}),(0,k.jsx)(`td`,{children:`Value`}),(0,k.jsx)(`td`,{children:`Computed value`}),(0,k.jsx)(`td`,{children:`Expensive calculations like filtering, sorting, or transforming large datasets`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`orange`,children:`useCallback`})}),(0,k.jsx)(`td`,{children:`Function`}),(0,k.jsx)(`td`,{children:`Function reference`}),(0,k.jsx)(`td`,{children:`Passing callbacks to React.memo children or as effect dependencies`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`purple`,children:`React.lazy`})}),(0,k.jsx)(`td`,{children:`Module`}),(0,k.jsx)(`td`,{children:`Component chunk`}),(0,k.jsx)(`td`,{children:`Route-level or heavy component splitting to reduce initial bundle size`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`yellow`,children:`useTransition`})}),(0,k.jsx)(`td`,{children:`Update priority`}),(0,k.jsx)(`td`,{children:`Deferred state update`}),(0,k.jsx)(`td`,{children:`Mark non-urgent updates (like search results filtering) as low priority`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`red`,children:`useDeferredValue`})}),(0,k.jsx)(`td`,{children:`Value priority`}),(0,k.jsx)(`td`,{children:`Deferred value`}),(0,k.jsx)(`td`,{children:`Show stale data while expensive re-render is in progress`})]})]})]}),(0,k.jsxs)(j,{id:`virtualization`,icon:`📜`,iconBg:`#fff7ed`,iconColor:`#ea580c`,title:`4.3 Virtualization & Large Lists`,children:[(0,k.jsx)(`p`,{children:`Rendering thousands of DOM nodes will inevitably crash the browser or cause severe jank, regardless of how well you memoize. Virtualization (or "windowing") solves this by only rendering the specific items currently visible in the user's viewport.`}),(0,k.jsxs)(`p`,{children:[`Libraries like `,(0,k.jsx)(`code`,{children:`react-window`}),` or `,(0,k.jsx)(`code`,{children:`react-virtuoso`}),` handle the math required to absolutely position items inside a scrolling container, dynamically swapping data as the user scrolls.`]})]}),(0,k.jsxs)(j,{id:`concurrent-features`,icon:`⏳`,iconBg:`#fff7ed`,iconColor:`#ea580c`,title:`4.4 React 18 Concurrent Features`,children:[(0,k.jsx)(`p`,{children:`React 18 introduced concurrent rendering, allowing React to pause, abort, and resume renders. This is exposed primarily through two hooks:`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsxs)(`strong`,{children:[(0,k.jsx)(`code`,{children:`useTransition`}),`:`]}),` Marks a state update as non-urgent. If the user types into an input, React will prioritize rendering the keystroke over rendering the heavy search results.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsxs)(`strong`,{children:[(0,k.jsx)(`code`,{children:`useDeferredValue`}),`:`]}),` Similar to useTransition, but used when you receive a value from above (as a prop) and want to defer updating the UI that depends on it.`]})]}),(0,k.jsx)(M,{filename:`useTransition.jsx`,language:`jsx`,children:`import { useState, useTransition } from 'react';
...
}`})]}),(0,k.jsxs)(j,{id:`responsive-design`,icon:`📱`,iconBg:`rgba(59,130,246,0.15)`,iconColor:`#3b82f6`,title:`5.2 — Responsive Design Implementation`,children:[(0,k.jsx)(`h4`,{children:`The Mobile-First Approach`}),(0,k.jsxs)(`p`,{children:[`Mobile-first means writing your base styles for the smallest screen, then layering on complexity with `,(0,k.jsx)(`code`,{children:`min-width`}),` media queries. This forces you to prioritize content and performance—mobile users get only the CSS they need, while desktop users progressively receive richer layouts. It mirrors how designers think: `,(0,k.jsx)(`em`,{children:`what's essential?`})]}),(0,k.jsx)(`h4`,{children:`Breakpoint System`}),(0,k.jsxs)(Er,{headers:[`Name`,`Min Width`,`Target`,`CSS Variable`],children:[(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`blue`,children:`sm`})}),(0,k.jsx)(`td`,{children:`640px`}),(0,k.jsx)(`td`,{children:`Large phones`}),(0,k.jsx)(`td`,{children:(0,k.jsx)(`code`,{children:`--bp-sm`})})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`blue`,children:`md`})}),(0,k.jsx)(`td`,{children:`768px`}),(0,k.jsx)(`td`,{children:`Tablets`}),(0,k.jsx)(`td`,{children:(0,k.jsx)(`code`,{children:`--bp-md`})})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`blue`,children:`lg`})}),(0,k.jsx)(`td`,{children:`1024px`}),(0,k.jsx)(`td`,{children:`Laptops`}),(0,k.jsx)(`td`,{children:(0,k.jsx)(`code`,{children:`--bp-lg`})})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`blue`,children:`xl`})}),(0,k.jsx)(`td`,{children:`1280px`}),(0,k.jsx)(`td`,{children:`Desktops`}),(0,k.jsx)(`td`,{children:(0,k.jsx)(`code`,{children:`--bp-xl`})})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`blue`,children:`2xl`})}),(0,k.jsx)(`td`,{children:`1536px`}),(0,k.jsx)(`td`,{children:`Large screens`}),(0,k.jsx)(`td`,{children:(0,k.jsx)(`code`,{children:`--bp-2xl`})})]})]}),(0,k.jsx)(M,{filename:`responsive-grid.css`,language:`CSS`,children:`<span class="cm">/* Mobile-first responsive grid */</span>
...
<span class="kw">import</span> <span class="fn">MyComponent</span>, { <span class="attr">API_URL</span> } <span class="kw">from</span> <span class="str">'./MyComponent'</span>;`})]}),(0,k.jsxs)(j,{id:`react-hooks-state-management`,icon:`🪝`,iconBg:`rgba(34,197,94,0.15)`,iconColor:`#22c55e`,title:`8.2 — React Hooks & State Management`,children:[(0,k.jsx)(`p`,{children:`Hooks revolutionized React by allowing function components to manage state, side effects, context, and refs—capabilities previously reserved for class components. They promote composition over inheritance and make logic reusable through custom hooks.`}),(0,k.jsx)(`h4`,{children:`Mental Model`}),(0,k.jsxs)(`p`,{children:[`Think of a component as a function that runs on every render. Hooks are "memory slots" attached to that component instance. `,(0,k.jsx)(`code`,{children:`useState`}),`gives you a slot for a value that persists across renders.`,(0,k.jsx)(`code`,{children:` useEffect`}),` gives you a slot for a side effect that runs after the DOM updates. `,(0,k.jsx)(`code`,{children:`useRef`}),` gives you a mutable box that doesn't trigger re-renders. The order you call hooks determines which slot you're accessing—that's why hooks must always be called in the same order (no conditionals, no loops).`]}),(0,k.jsxs)(Er,{headers:[`Hook`,`Purpose`,`Common Use Case`],children:[(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`blue`,children:`useState`})}),(0,k.jsx)(`td`,{children:`Manage simple local state`}),(0,k.jsx)(`td`,{children:`Form inputs, toggles, counters`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`blue`,children:`useEffect`})}),(0,k.jsx)(`td`,{children:`Side effects after render`}),(0,k.jsx)(`td`,{children:`API calls, subscriptions, DOM manipulation`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`purple`,children:`useContext`})}),(0,k.jsx)(`td`,{children:`Access context values`}),(0,k.jsx)(`td`,{children:`Theme, auth, locale without prop drilling`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`orange`,children:`useReducer`})}),(0,k.jsx)(`td`,{children:`Complex state with actions`}),(0,k.jsx)(`td`,{children:`Forms with many fields, state machines`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`green`,children:`useRef`})}),(0,k.jsx)(`td`,{children:`Mutable ref that persists across renders`}),(0,k.jsx)(`td`,{children:`DOM refs, previous values, timers`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(P,{variant:`green`,children:`useId`})}),(0,k.jsx)(`td`,{children:`Generate unique IDs for accessibility`}),(0,k.jsx)(`td`,{children:`Linking labels to inputs, ARIA attributes`})]})]}),(0,k.jsx)(M,{filename:`useFormReducer.js`,language:`JavaScript`,children:`<span class="kw">import</span> { <span class="fn">useReducer</span>, <span class="fn">useCallback</span> } <span class="kw">from</span> <span class="str">'react'</span>;
