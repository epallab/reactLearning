...
└── <span class="fn">services/</span>`})]}),(0,b.jsxs)(C,{id:`scalable-component-example`,icon:`🏗️`,iconBg:`#e8f0fe`,iconColor:`#1a73e8`,title:`1.2 Building a Scalable Component: Full Example`,children:[(0,b.jsx)(`p`,{children:`Let's build a production-quality Button component that demonstrates all the principles we've discussed. This button supports multiple variants, sizes, loading states, and icon placement.`}),(0,b.jsx)(`h4`,{children:`Key Design Decisions`}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Variant prop (enum):`}),` Instead of boolean props like `,(0,b.jsx)(`code`,{children:`isPrimary`}),`,`,(0,b.jsx)(`code`,{children:`isSecondary`}),`, we use a single `,(0,b.jsx)(`code`,{children:`variant`}),` prop. This prevents invalid states (what happens if both are true?) and makes the API cleaner.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Polymorphic rendering:`}),` The `,(0,b.jsx)(`code`,{children:`as`}),` prop lets the button render as a different element (like an anchor tag) while keeping the same styles. This is essential for accessibility.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Forwarded refs:`}),` Using `,(0,b.jsx)(`code`,{children:`React.forwardRef`}),` ensures parent components can access the underlying DOM node for focus management, measurements, or animations.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Rest props spreading:`}),` The `,(0,b.jsx)(`code`,{children:`...rest`}),` pattern passes through any additional HTML attributes (like `,(0,b.jsx)(`code`,{children:`aria-label`}),`, `,(0,b.jsx)(`code`,{children:`data-testid`}),`) without explicitly defining them.`]})]}),(0,b.jsx)(w,{filename:`Button.jsx`,language:`jsx`,children:`<span class="kw">import</span> React <span class="kw">from</span> <span class="str">'react'</span>;
...
<span class="kw">export default</span> Button;`}),(0,b.jsx)(w,{filename:`Button.module.css`,language:`css`,children:`<span class="fn">.button</span> {
...
}`}),(0,b.jsx)(w,{filename:`Usage Examples`,language:`jsx`,children:`<span class="cm">// Primary button</span>
...
<span class="tag">&lt;Button</span> <span class="attr">variant</span><span class="op">=</span><span class="str">"danger"</span> <span class="attr">size</span><span class="op">=</span><span class="str">"large"</span> <span class="attr">onClick</span><span class="op">=</span>{handleDelete}<span class="tag">&gt;</span>
  Delete Account
<span class="tag">&lt;/Button&gt;</span>`}),(0,b.jsxs)(T,{type:`tip`,title:`Barrel Exports`,children:[`Create an `,(0,b.jsx)(`code`,{children:`index.js`}),` file in each component folder that re-exports the component. This lets consumers import with cleaner paths: `,(0,b.jsx)(`code`,{children:`import Button from '@/components/atoms/Button'`}),`instead of `,(0,b.jsx)(`code`,{children:`import Button from '@/components/atoms/Button/Button'`}),`. It also gives you a single place to control what's publicly exposed from each module.`]})]}),(0,b.jsxs)(C,{id:`react-server-components`,icon:`☁️`,iconBg:`#e8f0fe`,iconColor:`#1a73e8`,title:`1.3 React Server Components (RSC)`,children:[(0,b.jsx)(`p`,{children:`React Server Components (RSC) represent a paradigm shift in how we build React applications. By rendering components exclusively on the server, RSCs eliminate the need to send heavy dependencies and bundle sizes to the client.`}),(0,b.jsx)(T,{type:`note`,title:`Client vs Server Components`,children:(0,b.jsxs)(`p`,{children:[`By default in modern frameworks like Next.js App Router, all components are Server Components. You only add the `,(0,b.jsx)(`code`,{children:`"use client"`}),` directive when you need interactivity (like `,(0,b.jsx)(`code`,{children:`onClick`}),`) or hooks (like `,(0,b.jsx)(`code`,{children:`useState`}),`).`]})})]}),(0,b.jsxs)(C,{id:`advanced-prop-patterns`,icon:`🎛️`,iconBg:`#e8f0fe`,iconColor:`#1a73e8`,title:`1.4 Advanced Prop Patterns`,children:[(0,b.jsx)(`p`,{children:`As components scale, passing basic primitive props isn't always enough. Two powerful patterns emerge for flexible composition:`}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Render Props:`}),` Passing a function as a prop to share state logic without higher-order components.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Polymorphism:`}),` Using an `,(0,b.jsx)(`code`,{children:`as`}),` prop (like we did in the Button example) to dynamically change the underlying HTML element while maintaining styles.`]})]})]})]});function O({headers:e,children:t}){return(0,b.jsx)(`div`,{className:`table-wrapper`,children:(0,b.jsxs)(`table`,{children:[(0,b.jsx)(`thead`,{children:(0,b.jsx)(`tr`,{children:e.map((e,t)=>(0,b.jsx)(`th`,{children:e},t))})}),(0,b.jsx)(`tbody`,{children:t})]})})}function k({variant:e=`blue`,children:t}){return(0,b.jsx)(`span`,{className:`badge badge-${e}`,children:t})}var ce=()=>(0,b.jsxs)(ie,{id:`chapter-2`,number:2,title:`RESTful API Integration & Data Flow`,theme:`purple`,children:[(0,b.jsx)(`p`,{children:`Modern React applications rarely exist in isolation — they communicate with back-end services to fetch data, submit forms, and synchronize state. Seamless communication between your front-end and back-end is essential for building responsive, reliable user experiences. This chapter covers everything from REST fundamentals to production-grade API layers with interceptors, error handling, and caching strategies.`}),(0,b.jsx)(`h3`,{children:`What is REST?`}),(0,b.jsx)(`p`,{children:`REST (Representational State Transfer) is an architectural style for designing networked applications. RESTful APIs use standard HTTP methods to perform CRUD operations on resources identified by URLs. Each request is stateless — the server doesn't remember previous requests, so every request must contain all the information needed to process it.`}),(0,b.jsx)(`h3`,{children:`HTTP Methods`}),(0,b.jsxs)(O,{headers:[`Method`,`Purpose`,`Has Body`,`Idempotent`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`GET`})}),(0,b.jsx)(`td`,{children:`Retrieve a resource or collection`}),(0,b.jsx)(`td`,{children:`No`}),(0,b.jsx)(`td`,{children:`Yes`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`POST`})}),(0,b.jsx)(`td`,{children:`Create a new resource`}),(0,b.jsx)(`td`,{children:`Yes`}),(0,b.jsx)(`td`,{children:`No`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`PUT`})}),(0,b.jsx)(`td`,{children:`Replace an entire resource`}),(0,b.jsx)(`td`,{children:`Yes`}),(0,b.jsx)(`td`,{children:`Yes`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`yellow`,children:`PATCH`})}),(0,b.jsx)(`td`,{children:`Partially update a resource`}),(0,b.jsx)(`td`,{children:`Yes`}),(0,b.jsx)(`td`,{children:`No`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`red`,children:`DELETE`})}),(0,b.jsx)(`td`,{children:`Remove a resource`}),(0,b.jsx)(`td`,{children:`Rarely`}),(0,b.jsx)(`td`,{children:`Yes`})]})]}),(0,b.jsx)(`h3`,{children:`HTTP Status Codes`}),(0,b.jsxs)(O,{headers:[`Code`,`Name`,`Meaning`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`200`})}),(0,b.jsx)(`td`,{children:`OK`}),(0,b.jsx)(`td`,{children:`Request succeeded, response body contains data`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`201`})}),(0,b.jsx)(`td`,{children:`Created`}),(0,b.jsx)(`td`,{children:`Resource successfully created (typically after POST)`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`204`})}),(0,b.jsx)(`td`,{children:`No Content`}),(0,b.jsx)(`td`,{children:`Request succeeded, no response body (typical for DELETE)`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`400`})}),(0,b.jsx)(`td`,{children:`Bad Request`}),(0,b.jsx)(`td`,{children:`Client sent invalid data (validation errors)`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`red`,children:`401`})}),(0,b.jsx)(`td`,{children:`Unauthorized`}),(0,b.jsx)(`td`,{children:`Authentication required or token expired`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`red`,children:`403`})}),(0,b.jsx)(`td`,{children:`Forbidden`}),(0,b.jsx)(`td`,{children:`Authenticated but lacks permission`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`404`})}),(0,b.jsx)(`td`,{children:`Not Found`}),(0,b.jsx)(`td`,{children:`Resource doesn't exist at the given URL`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`yellow`,children:`429`})}),(0,b.jsx)(`td`,{children:`Too Many Requests`}),(0,b.jsx)(`td`,{children:`Rate limit exceeded, slow down`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`red`,children:`500`})}),(0,b.jsx)(`td`,{children:`Internal Server Error`}),(0,b.jsx)(`td`,{children:`Server-side error, not the client's fault`})]})]}),(0,b.jsxs)(T,{type:`important`,title:`API Layer Abstraction`,children:[`Never scatter `,(0,b.jsx)(`code`,{children:`fetch()`}),` or `,(0,b.jsx)(`code`,{children:`axios`}),` calls directly inside your components. Instead, create a dedicated API layer (`,(0,b.jsx)(`code`,{children:`services/api.js`}),`) that centralizes all HTTP communication. This gives you a single place to handle base URLs, authentication headers, error transformation, retry logic, and request/response logging. When the API changes, you update one file — not fifty components.`]}),(0,b.jsx)(`h3`,{children:`Frontend ↔ Backend Data Flow`}),(0,b.jsxs)(ae,{children:[(0,b.jsxs)(oe,{children:[(0,b.jsx)(E,{children:`React Component`}),(0,b.jsx)(D,{}),(0,b.jsx)(E,{children:`Custom Hook`}),(0,b.jsx)(D,{}),(0,b.jsx)(E,{children:`API Service Layer`}),(0,b.jsx)(D,{}),(0,b.jsx)(E,{children:`HTTP Client (Axios)`})]}),(0,b.jsxs)(oe,{children:[(0,b.jsx)(E,{children:`HTTP Client (Axios)`}),(0,b.jsx)(D,{}),(0,b.jsx)(E,{children:`REST API Server`}),(0,b.jsx)(D,{}),(0,b.jsx)(E,{children:`Database`})]})]}),(0,b.jsxs)(C,{id:`use-api-hook`,icon:`🔗`,iconBg:`#f3e8ff`,iconColor:`#7c3aed`,title:`2.1 Custom Hook: useApi`,children:[(0,b.jsxs)(`p`,{children:[`A well-designed API hook encapsulates the three fundamental states of any asynchronous operation: `,(0,b.jsx)(`strong`,{children:`loading`}),`, `,(0,b.jsx)(`strong`,{children:`data`}),`, and `,(0,b.jsx)(`strong`,{children:`error`}),`. This pattern eliminates boilerplate and ensures consistent handling across your application.`]}),(0,b.jsx)(`h4`,{children:`Three States of Async Operations`}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Loading:`}),` The request is in flight. Show a spinner, skeleton, or placeholder content. Never leave the user staring at a blank screen.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Success (Data):`}),` The server responded with the expected data. Render your UI components with the received data.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Error:`}),` Something went wrong — network failure, server error, or invalid response. Show a meaningful error message with a retry option.`]})]}),(0,b.jsx)(`h4`,{children:`AbortController`}),(0,b.jsxs)(`p`,{children:[`The `,(0,b.jsx)(`code`,{children:`AbortController`}),` API lets you cancel in-flight HTTP requests. This is critical for preventing race conditions and memory leaks. If a user navigates away from a page before the API call completes, the request should be aborted — otherwise, the response will try to update state on an unmounted component. Our `,(0,b.jsx)(`code`,{children:`useApi`}),` hook integrates this automatically via the cleanup function in `,(0,b.jsx)(`code`,{children:`useEffect`}),`.`]}),(0,b.jsx)(w,{filename:`useApi.js`,language:`javascript`,children:`<span class="kw">import</span> { useState, useEffect, useCallback } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`}),(0,b.jsx)(w,{filename:`UserList.jsx`,language:`jsx`,children:`<span class="kw">import</span> { useApi } <span class="kw">from</span> <span class="str">'../hooks/useApi'</span>;
...
}`})]}),(0,b.jsxs)(C,{id:`axios-interceptors`,icon:`🛡️`,iconBg:`#f3e8ff`,iconColor:`#7c3aed`,title:`2.2 Axios Interceptors & Error Handling`,children:[(0,b.jsxs)(`p`,{children:[`Axios interceptors let you intercept requests and responses before they are handled by`,(0,b.jsx)(`code`,{children:`then`}),` or `,(0,b.jsx)(`code`,{children:`catch`}),`. This is where you build your app's defensive layer — handling authentication, retrying failed requests, and transforming errors into user-friendly messages.`]}),(0,b.jsx)(`h4`,{children:`What Interceptors Handle`}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Request Interceptors:`}),` Attach auth tokens, set default headers, log outgoing requests`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Response Interceptors:`}),` Transform responses, handle errors globally, refresh expired tokens`]})]}),(0,b.jsx)(`h4`,{children:`Token Refresh Flow`}),(0,b.jsxs)(`ol`,{children:[(0,b.jsx)(`li`,{children:`User's access token expires mid-session`}),(0,b.jsxs)(`li`,{children:[`API returns `,(0,b.jsx)(`code`,{children:`401 Unauthorized`})]}),(0,b.jsx)(`li`,{children:`Response interceptor catches the 401`}),(0,b.jsxs)(`li`,{children:[`Interceptor sends refresh token to `,(0,b.jsx)(`code`,{children:`/auth/refresh`}),` endpoint`]}),(0,b.jsx)(`li`,{children:`Server responds with a new access token`}),(0,b.jsx)(`li`,{children:`Interceptor retries the original failed request with the new token`}),(0,b.jsx)(`li`,{children:`User never notices the token expired — seamless experience`})]}),(0,b.jsx)(T,{type:`note`,title:`Why This is Powerful`,children:`Without interceptors, you'd need to add token refresh logic to every single API call in your app. With interceptors, you write it once and every request automatically benefits. This is the API layer abstraction principle in action.`}),(0,b.jsx)(w,{filename:`apiClient.js`,language:`javascript`,children:`<span class="kw">import</span> axios <span class="kw">from</span> <span class="str">'axios'</span>;
...
<span class="kw">export default</span> apiClient;`}),(0,b.jsxs)(T,{type:`warning`,title:`Security Note: localStorage Tokens`,children:[`Storing tokens in `,(0,b.jsx)(`code`,{children:`localStorage`}),` is convenient but vulnerable to XSS attacks. For production applications, consider using `,(0,b.jsx)(`code`,{children:`httpOnly`}),` cookies set by the server, which are not accessible via JavaScript. If you must use localStorage, ensure your app has robust XSS protection including Content Security Policy headers and input sanitization.`]})]}),(0,b.jsxs)(C,{id:`state-management-server-data`,icon:`🗄️`,iconBg:`#f3e8ff`,iconColor:`#7c3aed`,title:`2.3 State Management for Server Data`,children:[(0,b.jsxs)(`p`,{children:[`While custom hooks like `,(0,b.jsx)(`code`,{children:`useApi`}),` are great for understanding the fundamentals, production apps often rely on specialized libraries like React Query (TanStack Query) or SWR to manage server state.`]}),(0,b.jsx)(T,{type:`note`,title:`Server State vs Client State`,children:(0,b.jsxs)(`p`,{children:[`Server state is asynchronous, shared, and can become out of date. Client state is synchronous and local to the user's session (e.g., UI toggles). Libraries like React Query specifically handle the caching, deduplication, and background updates of `,(0,b.jsx)(`strong`,{children:`Server State`}),`.`]})})]}),(0,b.jsxs)(C,{id:`websockets-real-time`,icon:`⚡`,iconBg:`#f3e8ff`,iconColor:`#7c3aed`,title:`2.4 WebSockets & Real-Time Data`,children:[(0,b.jsx)(`p`,{children:`For applications that require live updates (chat apps, trading dashboards), REST polling is inefficient. WebSockets provide a persistent, bi-directional connection between the client and server.`}),(0,b.jsx)(w,{filename:`useWebSocket.js`,language:`javascript`,children:`<span class="kw">import</span> { useEffect, useRef } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`})]})]}),le=()=>(0,b.jsxs)(ie,{id:`chapter-3`,number:3,title:`Clean, Modular & Reusable Code`,theme:`green`,children:[(0,b.jsx)(`p`,{children:`Writing code that works is the baseline. Writing code that's clean, modular, and reusable is what separates junior developers from senior engineers. Clean code reads like well-written prose — its intent is clear, its structure is logical, and its patterns are consistent. This chapter covers the principles, patterns, and practical techniques that make React codebases a joy to work in, even as they scale to hundreds of components.`}),(0,b.jsx)(`h3`,{children:`Key Principles`}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`DRY (Don't Repeat Yourself):`}),` If you find yourself writing the same logic in multiple places, extract it into a shared utility, custom hook, or component. But don't over-DRY — sometimes a little duplication is better than the wrong abstraction.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`SOLID Principles:`}),` Originally from OOP, these principles apply beautifully to React. Single Responsibility (one component = one job), Open/Closed (extend via composition, not modification), Liskov Substitution (components should be interchangeable), Interface Segregation (don't force components to depend on props they don't use), Dependency Inversion (depend on abstractions like hooks, not concrete implementations).`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`AHA (Avoid Hasty Abstractions):`}),` Don't create an abstraction until you've seen the pattern at least three times. Premature abstraction creates more problems than duplication. Wait until the pattern is clear, then extract with confidence.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`File Naming Conventions:`}),` Use PascalCase for components (`,(0,b.jsx)(`code`,{children:`UserProfile.jsx`}),`), camelCase for hooks (`,(0,b.jsx)(`code`,{children:`useAuth.js`}),`), and kebab-case for utilities (`,(0,b.jsx)(`code`,{children:`format-date.js`}),`). Consistency in naming makes it easy to identify what a file contains at a glance.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Barrel Exports:`}),` Use `,(0,b.jsx)(`code`,{children:`index.js`}),` files to re-export related modules. This simplifies imports and gives you a clear public API for each module. But be careful — barrel files can hurt tree-shaking if not used thoughtfully.`]})]}),(0,b.jsx)(T,{type:`tip`,title:`The Litmus Test`,children:`Before creating an abstraction, ask yourself: "If I delete this abstraction, how many files do I need to update?" If the answer is less than three, the abstraction probably isn't worth it yet. Also ask: "Can a new team member understand this abstraction in under 5 minutes?" If not, simplify it.`}),(0,b.jsxs)(C,{id:`custom-hooks`,icon:`🪝`,iconBg:`#ecfdf5`,iconColor:`#059669`,title:`3.1 Custom Hooks Pattern`,children:[(0,b.jsxs)(`p`,{children:[`Custom hooks are the primary mechanism for extracting and reusing stateful logic in React. They let you share behavior between components without changing their structure. A custom hook is simply a function that starts with `,(0,b.jsx)(`code`,{children:`use`}),` and calls other hooks internally.`]}),(0,b.jsx)(`h4`,{children:`Rules of Hooks`}),(0,b.jsxs)(`ol`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Only call hooks at the top level`}),` — never inside loops, conditions, or nested functions. React relies on the order of hook calls to maintain state correctly.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Only call hooks from React functions`}),` — either functional components or other custom hooks. Never call hooks from regular JavaScript functions.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Name must start with "use"`}),` — this convention tells React's linter to enforce the rules of hooks on your custom function.`]})]}),(0,b.jsx)(`h4`,{children:`When to Create a Custom Hook`}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[`You're duplicating the same `,(0,b.jsx)(`code`,{children:`useState`}),` + `,(0,b.jsx)(`code`,{children:`useEffect`}),` pattern across components`]}),(0,b.jsx)(`li`,{children:`A component has complex logic that obscures its rendering intent`}),(0,b.jsx)(`li`,{children:`You want to share behavior (not UI) between components`}),(0,b.jsx)(`li`,{children:`You need to encapsulate a subscription, timer, or external data source`})]}),(0,b.jsx)(w,{filename:`useDebounce.js`,language:`javascript`,children:`<span class="kw">import</span> { useState, useEffect } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`}),(0,b.jsx)(w,{filename:`useLocalStorage.js`,language:`javascript`,children:`<span class="kw">import</span> { useState, useEffect } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`}),(0,b.jsx)(w,{filename:`Usage: Search with Debounce`,language:`jsx`,children:`<span class="kw">import</span> { useState } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`})]}),(0,b.jsxs)(C,{id:`compound-components`,icon:`🧩`,iconBg:`#ecfdf5`,iconColor:`#059669`,title:`3.2 Compound Component Pattern`,children:[(0,b.jsxs)(`p`,{children:[`The Compound Component pattern lets you create components that work together to form a complete UI element, while giving the consumer full control over rendering order and structure. Think of it like the `,(0,b.jsx)(`code`,{children:`<select>`}),` and `,(0,b.jsx)(`code`,{children:`<option>`}),`relationship in HTML — they're separate elements but they share implicit state.`]}),(0,b.jsx)(`p`,{children:`This pattern is ideal for components like accordions, tabs, dropdowns, and menus where the parent manages shared state and the children consume it via React Context. The consumer gets a flexible API without needing to wire up state management manually.`}),(0,b.jsx)(w,{filename:`Accordion.jsx`,language:`jsx`,children:`<span class="kw">import</span> { createContext, useContext, useState } <span class="kw">from</span> <span class="str">'react'</span>;
...
<span class="cm">// &lt;/Accordion&gt;</span>`})]}),(0,b.jsxs)(C,{id:`higher-order-components`,icon:`🔄`,iconBg:`#ecfdf5`,iconColor:`#059669`,title:`3.3 Higher-Order Components (HOCs)`,children:[(0,b.jsx)(`p`,{children:`Before Hooks were introduced in React 16.8, Higher-Order Components (HOCs) were the primary way to reuse component logic. An HOC is a function that takes a component and returns a new component, wrapping it with additional props or behavior.`}),(0,b.jsx)(w,{filename:`withAuth.jsx`,language:`jsx`,children:`export function withAuth(WrappedComponent) {
  return function ProtectedRoute(props) {
    const isAuthenticated = useAuth();
    if (!isAuthenticated) return <Redirect to="/login" />;
    return <WrappedComponent {...props} />;
  };
}`}),(0,b.jsx)(T,{type:`warning`,title:`HOCs vs Hooks`,children:(0,b.jsx)(`p`,{children:`While HOCs are still supported, Custom Hooks are generally preferred today because they avoid "wrapper hell" (deeply nested component trees) and make it clearer where state is coming from. Use HOCs primarily for routing guards or legacy class components.`})})]}),(0,b.jsxs)(C,{id:`dependency-injection-context`,icon:`💉`,iconBg:`#ecfdf5`,iconColor:`#059669`,title:`3.4 Dependency Injection via Context`,children:[(0,b.jsx)(`p`,{children:`React Context is often viewed merely as a state management tool, but it's fundamentally a Dependency Injection (DI) system. You can use Context to inject services (like logging, analytics, or API clients) deep into your component tree without prop drilling.`}),(0,b.jsx)(`p`,{children:`This makes your components highly testable, as you can easily wrap them in a mock provider during unit testing.`})]})]}),ue=()=>(0,b.jsxs)(ie,{id:`chapter-4`,number:4,title:`Performance Optimization & Lazy Loading`,theme:`orange`,children:[(0,b.jsx)(`p`,{children:`Performance isn't a feature — it's a requirement. Users expect your application to load instantly, respond immediately to interactions, and never stutter during animations. A slow app loses users: studies show that 53% of mobile users abandon sites that take longer than 3 seconds to load. This chapter covers how React's rendering model works under the hood, how to measure performance with Core Web Vitals, and the specific techniques — code splitting, memoization, and lazy loading — that keep your app fast at any scale.`}),(0,b.jsx)(`h3`,{children:`Core Web Vitals`}),(0,b.jsxs)(O,{headers:[`Metric`,`Full Name`,`Good Target`,`What It Measures`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`LCP`})}),(0,b.jsx)(`td`,{children:`Largest Contentful Paint`}),(0,b.jsx)(`td`,{children:`≤ 2.5s`}),(0,b.jsx)(`td`,{children:`Time until the largest visible element (image, text block) is rendered. Measures perceived load speed.`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`FID`})}),(0,b.jsx)(`td`,{children:`First Input Delay`}),(0,b.jsx)(`td`,{children:`≤ 100ms`}),(0,b.jsx)(`td`,{children:`Time from first user interaction (click, tap) to the browser's response. Measures interactivity responsiveness.`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`CLS`})}),(0,b.jsx)(`td`,{children:`Cumulative Layout Shift`}),(0,b.jsx)(`td`,{children:`≤ 0.1`}),(0,b.jsx)(`td`,{children:`Measures visual stability — how much elements shift during page load. Low scores mean a stable layout.`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`TTI`})}),(0,b.jsx)(`td`,{children:`Time to Interactive`}),(0,b.jsx)(`td`,{children:`≤ 3.8s`}),(0,b.jsx)(`td`,{children:`Time until the page is fully interactive and responds to user input without delay.`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`red`,children:`TBT`})}),(0,b.jsx)(`td`,{children:`Total Blocking Time`}),(0,b.jsx)(`td`,{children:`≤ 200ms`}),(0,b.jsx)(`td`,{children:`Total time the main thread was blocked by long tasks (>50ms) between FCP and TTI.`})]})]}),(0,b.jsx)(`h3`,{children:`How React's Rendering Model Works`}),(0,b.jsx)(`p`,{children:`React uses a Virtual DOM — a lightweight JavaScript representation of the actual DOM. When state changes, React creates a new Virtual DOM tree, diffs it against the previous one (reconciliation), and applies only the minimal set of changes to the real DOM. This process has three phases:`}),(0,b.jsxs)(`ol`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Trigger:`}),` A state update is triggered (via `,(0,b.jsx)(`code`,{children:`setState`}),`,`,(0,b.jsx)(`code`,{children:`useReducer dispatch`}),`, or a parent re-render).`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Render:`}),` React calls your component function to compute the new JSX output. This is pure computation — no DOM manipulation happens here.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Commit:`}),` React compares the new Virtual DOM with the previous one and applies the differences to the actual DOM. This is the only phase that touches the browser.`]})]}),(0,b.jsx)(T,{type:`warning`,title:`Common Performance Anti-Patterns`,children:(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Creating objects/arrays inside render:`}),` Every render creates a new reference, causing child components to re-render unnecessarily.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Inline function definitions in JSX:`}),` `,(0,b.jsx)(`code`,{children:`onClick={() => handleClick(id)}`}),` creates a new function on every render.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Not using keys properly:`}),` Using array index as key causes React to remount components instead of reordering them.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Unnecessary state:`}),` Derived data should be computed during render, not stored in state. If you can calculate it from existing state or props, don't add another `,(0,b.jsx)(`code`,{children:`useState`}),`.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Context overuse:`}),` Putting too much data in a single Context causes every consumer to re-render when any value changes.`]})]})}),(0,b.jsxs)(C,{id:`lazy-loading`,icon:`⚡`,iconBg:`#fff7ed`,iconColor:`#ea580c`,title:`4.1 React.lazy, Suspense & Code Splitting`,children:[(0,b.jsxs)(`p`,{children:[`Code splitting is the technique of breaking your JavaScript bundle into smaller chunks that are loaded on demand. Instead of loading your entire application upfront (which could be several megabytes), you load only what the user needs for the current view. React provides built-in support for code splitting via `,(0,b.jsx)(`code`,{children:`React.lazy`}),` and `,(0,b.jsx)(`code`,{children:`Suspense`}),`.`]}),(0,b.jsx)(`h4`,{children:`How It Works Under the Hood`}),(0,b.jsxs)(`ol`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`code`,{children:`React.lazy()`}),` takes a function that calls a dynamic `,(0,b.jsx)(`code`,{children:`import()`}),` — this tells your bundler (Vite, Webpack) to create a separate chunk for that module.`]}),(0,b.jsxs)(`li`,{children:[`When the lazy component is first rendered, React triggers the dynamic import and shows the`,(0,b.jsx)(`code`,{children:`Suspense`}),` fallback while the chunk is downloading.`]}),(0,b.jsx)(`li`,{children:`Once the chunk is loaded, React replaces the fallback with the actual component. Subsequent renders use the cached module — no additional network requests.`})]}),(0,b.jsx)(`h4`,{children:`Route-Based vs Component-Based Splitting`}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Route-Based:`}),` Split at the page/route level. Each page is a separate chunk. This is the most common and safest approach — users naturally expect a brief loading moment during navigation.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Component-Based:`}),` Split individual components that are heavy or rarely used (charts, rich text editors, modals). This is more granular and can significantly reduce initial bundle size.`]})]}),(0,b.jsx)(w,{filename:`App.jsx`,language:`jsx`,children:`<span class="kw">import</span> React, { Suspense, lazy } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`}),(0,b.jsx)(w,{filename:`useLazyLoad.js`,language:`javascript`,children:`<span class="kw">import</span> { useState, useEffect, useRef } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`})]}),(0,b.jsxs)(C,{id:`memoization`,icon:`🧠`,iconBg:`#fff7ed`,iconColor:`#ea580c`,title:`4.2 useMemo, useCallback & React.memo`,children:[(0,b.jsx)(`p`,{children:`Memoization is the technique of caching the result of an expensive computation so you don't have to repeat it on every render. React provides three memoization tools, each designed for a specific use case.`}),(0,b.jsx)(`h4`,{children:`Deep Dive: How Each One Works`}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`React.memo (Component-level):`}),` A higher-order component that wraps your component and performs a shallow comparison of its props. If the props haven't changed, React skips re-rendering the component entirely and reuses the previous output. Ideal for components that receive the same props frequently.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`useMemo (Value-level):`}),` Caches the result of an expensive computation between re-renders. React only recomputes the value when one of its dependencies changes. Use it for filtering large arrays, complex calculations, or creating derived data.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`useCallback (Function-level):`}),` Caches a function definition between re-renders. Without `,(0,b.jsx)(`code`,{children:`useCallback`}),`, every render creates a new function reference, which can cause child components wrapped in `,(0,b.jsx)(`code`,{children:`React.memo`}),` to re-render unnecessarily.`]})]}),(0,b.jsx)(T,{type:`note`,title:`React 18+ Automatic Batching`,children:`React 18 introduced automatic batching — multiple state updates inside event handlers, promises, setTimeout, and native event handlers are now batched into a single re-render automatically. This means React is already optimizing many scenarios that previously required manual intervention. Before reaching for memoization, make sure you actually have a performance problem — premature optimization adds complexity without benefit.`}),(0,b.jsx)(w,{filename:`Performance Optimization Patterns`,language:`jsx`,children:`<span class="kw">import</span> React, { useMemo, useCallback, useState } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`}),(0,b.jsx)(T,{type:`note`,title:`When to Memoize`,children:`Don't memoize everything — memoization has a cost (memory for caching, comparison overhead). Use it when: (1) a component re-renders often with the same props, (2) the render output is expensive to compute, (3) you're passing callbacks to memoized children, or (4) you have large lists that filter or sort on every render. Profile first with React DevTools Profiler, then optimize the actual bottlenecks.`}),(0,b.jsx)(`h4`,{children:`Performance Comparison Table`}),(0,b.jsxs)(O,{headers:[`Technique`,`Level`,`What It Caches`,`When to Use`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`React.memo`})}),(0,b.jsx)(`td`,{children:`Component`}),(0,b.jsx)(`td`,{children:`Rendered output (JSX)`}),(0,b.jsx)(`td`,{children:`Component receives same props frequently and is expensive to render`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`useMemo`})}),(0,b.jsx)(`td`,{children:`Value`}),(0,b.jsx)(`td`,{children:`Computed value`}),(0,b.jsx)(`td`,{children:`Expensive calculations like filtering, sorting, or transforming large datasets`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`useCallback`})}),(0,b.jsx)(`td`,{children:`Function`}),(0,b.jsx)(`td`,{children:`Function reference`}),(0,b.jsx)(`td`,{children:`Passing callbacks to React.memo children or as effect dependencies`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`React.lazy`})}),(0,b.jsx)(`td`,{children:`Module`}),(0,b.jsx)(`td`,{children:`Component chunk`}),(0,b.jsx)(`td`,{children:`Route-level or heavy component splitting to reduce initial bundle size`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`yellow`,children:`useTransition`})}),(0,b.jsx)(`td`,{children:`Update priority`}),(0,b.jsx)(`td`,{children:`Deferred state update`}),(0,b.jsx)(`td`,{children:`Mark non-urgent updates (like search results filtering) as low priority`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`red`,children:`useDeferredValue`})}),(0,b.jsx)(`td`,{children:`Value priority`}),(0,b.jsx)(`td`,{children:`Deferred value`}),(0,b.jsx)(`td`,{children:`Show stale data while expensive re-render is in progress`})]})]})]}),(0,b.jsxs)(C,{id:`virtualization`,icon:`📜`,iconBg:`#fff7ed`,iconColor:`#ea580c`,title:`4.3 Virtualization & Large Lists`,children:[(0,b.jsx)(`p`,{children:`Rendering thousands of DOM nodes will inevitably crash the browser or cause severe jank, regardless of how well you memoize. Virtualization (or "windowing") solves this by only rendering the specific items currently visible in the user's viewport.`}),(0,b.jsxs)(`p`,{children:[`Libraries like `,(0,b.jsx)(`code`,{children:`react-window`}),` or `,(0,b.jsx)(`code`,{children:`react-virtuoso`}),` handle the math required to absolutely position items inside a scrolling container, dynamically swapping data as the user scrolls.`]})]}),(0,b.jsxs)(C,{id:`concurrent-features`,icon:`⏳`,iconBg:`#fff7ed`,iconColor:`#ea580c`,title:`4.4 React 18 Concurrent Features`,children:[(0,b.jsx)(`p`,{children:`React 18 introduced concurrent rendering, allowing React to pause, abort, and resume renders. This is exposed primarily through two hooks:`}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[(0,b.jsxs)(`strong`,{children:[(0,b.jsx)(`code`,{children:`useTransition`}),`:`]}),` Marks a state update as non-urgent. If the user types into an input, React will prioritize rendering the keystroke over rendering the heavy search results.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsxs)(`strong`,{children:[(0,b.jsx)(`code`,{children:`useDeferredValue`}),`:`]}),` Similar to useTransition, but used when you receive a value from above (as a prop) and want to defer updating the UI that depends on it.`]})]}),(0,b.jsx)(w,{filename:`useTransition.jsx`,language:`jsx`,children:`import { useState, useTransition } from 'react';
...
}`})]})]});function de(){return(0,b.jsxs)(ie,{id:`collaborating-with-designers`,number:`05`,title:`Collaborating with UI/UX Designers`,theme:`blue`,children:[(0,b.jsx)(`p`,{className:`section-intro`,children:`The most impactful React applications are born from tight collaboration between developers and designers. This chapter explores how to bridge the gap between design and development—translating Figma mockups into maintainable component architectures, establishing shared design tokens, and building responsive layouts that honor the designer's vision across every screen size.`}),(0,b.jsx)(`h3`,{children:`Developer-Designer Collaboration Workflow`}),(0,b.jsxs)(`ol`,{className:`styled-list`,children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Design Handoff & Review`}),` — Walk through Figma/Sketch files together. Clarify spacing, states (hover, active, disabled, error), and responsive breakpoints`,(0,b.jsx)(`em`,{children:`before`}),` writing a single line of code.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Component Inventory`}),` — Map every unique UI element in the design to a React component. Identify shared patterns (buttons, cards, modals) that become your design system.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Token Extraction`}),` — Pull colors, typography scales, spacing units, and border radii from the design file and encode them as CSS custom properties or JS constants.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Iterative Build & QA`}),` — Build components in isolation (Storybook), then compose them into pages. Conduct pixel-level reviews with the designer at each milestone.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Living Style Guide`}),` — Maintain a component library that stays in sync with the design source of truth. Automate visual regression testing to catch drift.`]})]}),(0,b.jsx)(`h3`,{children:`Design System Fundamentals`}),(0,b.jsxs)(`div`,{className:`kv-grid`,children:[(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`4px / 8px Spacing Grid`}),(0,b.jsx)(`span`,{className:`kv-value`,children:`All spacing values are multiples of 4px. Use 8px as the base unit for padding, margins, and gaps. This ensures visual rhythm and consistency.`})]}),(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Typography Scale`}),(0,b.jsxs)(`span`,{className:`kv-value`,children:[`A modular type scale (e.g., 1.25 ratio) creates hierarchy: 12px → 14px → 16px → 20px → 24px → 32px → 40px → 48px. Map each to a semantic token like`,(0,b.jsx)(`code`,{children:`--font-size-sm`}),`, `,(0,b.jsx)(`code`,{children:`--font-size-base`}),`, `,(0,b.jsx)(`code`,{children:`--font-size-lg`}),`.`]})]}),(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Color System`}),(0,b.jsxs)(`span`,{className:`kv-value`,children:[`Define a palette with semantic names: `,(0,b.jsx)(`code`,{children:`--color-primary`}),`,`,(0,b.jsx)(`code`,{children:`--color-surface`}),`, `,(0,b.jsx)(`code`,{children:`--color-error`}),`. Include shades (50–900) for each hue to handle hover states, backgrounds, and borders.`]})]}),(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Shared Language`}),(0,b.jsxs)(`span`,{className:`kv-value`,children:[`Agree on naming conventions between design and code. If the designer calls it a "Card," the component is `,(0,b.jsx)(`code`,{children:`<Card />`}),`. Alignment on vocabulary eliminates ambiguity in standups, PRs, and Jira tickets.`]})]})]}),(0,b.jsxs)(C,{id:`design-tokens-theming`,icon:`🎨`,iconBg:`rgba(59,130,246,0.15)`,iconColor:`#3b82f6`,title:`5.1 — Design Tokens & Theming`,children:[(0,b.jsx)(`h4`,{children:`Why CSS Custom Properties?`}),(0,b.jsxs)(`ul`,{className:`styled-list`,children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Dynamic & Runtime`}),` — Unlike Sass variables, custom properties are live in the browser. You can change them with JavaScript, media queries, or class toggles without recompiling your stylesheets.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Inheritance & Cascading`}),` — Custom properties follow CSS inheritance rules. Set a token on `,(0,b.jsx)(`code`,{children:`:root`}),` and override it on any descendant element or component scope.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Dark Mode Made Easy`}),` — Swap an entire theme by toggling a`,(0,b.jsx)(`code`,{children:`data-theme="dark"`}),` attribute on `,(0,b.jsx)(`code`,{children:`<html>`}),`and redefining a handful of properties.`]})]}),(0,b.jsx)(w,{filename:`tokens.css`,language:`CSS`,children:`<span class="cm">/* ── Color Tokens ── */</span>
...
}`}),(0,b.jsx)(w,{filename:`dark-theme.css`,language:`CSS`,children:`<span class="cm">/* Dark theme overrides */</span>
...
}`})]}),(0,b.jsxs)(C,{id:`responsive-design`,icon:`📱`,iconBg:`rgba(59,130,246,0.15)`,iconColor:`#3b82f6`,title:`5.2 — Responsive Design Implementation`,children:[(0,b.jsx)(`h4`,{children:`The Mobile-First Approach`}),(0,b.jsxs)(`p`,{children:[`Mobile-first means writing your base styles for the smallest screen, then layering on complexity with `,(0,b.jsx)(`code`,{children:`min-width`}),` media queries. This forces you to prioritize content and performance—mobile users get only the CSS they need, while desktop users progressively receive richer layouts. It mirrors how designers think: `,(0,b.jsx)(`em`,{children:`what's essential?`})]}),(0,b.jsx)(`h4`,{children:`Breakpoint System`}),(0,b.jsxs)(O,{headers:[`Name`,`Min Width`,`Target`,`CSS Variable`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`sm`})}),(0,b.jsx)(`td`,{children:`640px`}),(0,b.jsx)(`td`,{children:`Large phones`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`--bp-sm`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`md`})}),(0,b.jsx)(`td`,{children:`768px`}),(0,b.jsx)(`td`,{children:`Tablets`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`--bp-md`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`lg`})}),(0,b.jsx)(`td`,{children:`1024px`}),(0,b.jsx)(`td`,{children:`Laptops`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`--bp-lg`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`xl`})}),(0,b.jsx)(`td`,{children:`1280px`}),(0,b.jsx)(`td`,{children:`Desktops`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`--bp-xl`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`2xl`})}),(0,b.jsx)(`td`,{children:`1536px`}),(0,b.jsx)(`td`,{children:`Large screens`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`--bp-2xl`})})]})]}),(0,b.jsx)(w,{filename:`responsive-grid.css`,language:`CSS`,children:`<span class="cm">/* Mobile-first responsive grid */</span>
...
}`}),(0,b.jsx)(w,{filename:`useMediaQuery.js`,language:`JavaScript`,children:`<span class="kw">import</span> { <span class="fn">useState</span>, <span class="fn">useEffect</span> } <span class="kw">from</span> <span class="str">'react'</span>;
...
<span class="cm">// const isDesktop = useMediaQuery('(min-width: 1024px)');</span>`}),(0,b.jsx)(T,{type:`tip`,title:`Designer-Developer Sync Tip`,children:(0,b.jsx)(`p`,{children:`Export your breakpoint values as both CSS custom properties and a shared JSON config. This way, designers and developers always reference the same breakpoints—no more "is tablet 768 or 800?" debates.`})})]}),(0,b.jsxs)(C,{id:`accessibility-first`,icon:`♿`,iconBg:`rgba(59,130,246,0.15)`,iconColor:`#3b82f6`,title:`5.3 — Accessibility (a11y) First`,children:[(0,b.jsx)(`p`,{children:`Accessibility shouldn't be an afterthought. Building inclusive applications means ensuring users who rely on screen readers, keyboard navigation, or have visual impairments can use your app without barriers.`}),(0,b.jsxs)(`ul`,{className:`styled-list`,children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Semantic HTML:`}),` Use `,(0,b.jsx)(`code`,{children:`<button>`}),` for actions and `,(0,b.jsx)(`code`,{children:`<a>`}),` for navigation. Don't use a `,(0,b.jsx)(`code`,{children:`<div>`}),` with an onClick handler unless absolutely necessary (and if you do, add `,(0,b.jsx)(`code`,{children:`role="button"`}),` and `,(0,b.jsx)(`code`,{children:`tabIndex={0}`}),`).`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Focus Management:`}),` When a modal opens, trap the focus inside it. When it closes, return focus to the element that opened it.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`ARIA Attributes:`}),` Use `,(0,b.jsx)(`code`,{children:`aria-expanded`}),` for accordions, `,(0,b.jsx)(`code`,{children:`aria-hidden`}),` for decorative icons, and `,(0,b.jsx)(`code`,{children:`aria-live`}),` for dynamic content updates (like toast notifications).`]})]})]}),(0,b.jsxs)(C,{id:`micro-animations`,icon:`✨`,iconBg:`rgba(59,130,246,0.15)`,iconColor:`#3b82f6`,title:`5.4 — Micro-Animations & Interactions`,children:[(0,b.jsx)(`p`,{children:`Subtle animations provide feedback and delight without getting in the way. Hover states, active press states, and smooth transitions when elements enter or leave the DOM turn a static page into a fluid experience.`}),(0,b.jsx)(T,{type:`tip`,title:`Framer Motion`,children:(0,b.jsxs)(`p`,{children:[`For complex orchestrated animations in React, `,(0,b.jsx)(`a`,{href:`https://www.framer.com/motion/`,target:`_blank`,rel:`noreferrer`,children:`Framer Motion`}),` is the industry standard. It handles layout animations, gesture recognition, and spring physics effortlessly.`]})})]})]})}function fe(){return(0,b.jsxs)(ie,{id:`version-control-git`,number:`06`,title:`Version Control with Git`,theme:`purple`,children:[(0,b.jsx)(`p`,{className:`section-intro`,children:`Git is the backbone of modern team collaboration. Beyond simply tracking changes, Git enables parallel development, safe experimentation via branches, and a reviewable history of every decision your team makes. Mastering Git workflows is what separates a solo coder from a productive team contributor.`}),(0,b.jsx)(`h3`,{children:`Git Fundamentals`}),(0,b.jsxs)(`div`,{className:`kv-grid`,children:[(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Distributed VCS`}),(0,b.jsx)(`span`,{className:`kv-value`,children:`Every developer has a full copy of the repository, including its entire history. You can commit, branch, and diff offline—no server required.`})]}),(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Three States`}),(0,b.jsxs)(`span`,{className:`kv-value`,children:[`Files move through three stages: `,(0,b.jsx)(`strong`,{children:`Working Directory`}),` (modified),`,(0,b.jsx)(`strong`,{children:` Staging Area`}),` (indexed), and `,(0,b.jsx)(`strong`,{children:`Repository`}),` (committed). Understanding this flow is key to every Git command.`]})]}),(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Snapshots, Not Diffs`}),(0,b.jsx)(`span`,{className:`kv-value`,children:`Git stores full snapshots of your project at each commit, not incremental diffs. This makes branching and merging extremely fast and reliable.`})]})]}),(0,b.jsxs)(C,{id:`git-branching-strategy`,icon:`🌿`,iconBg:`rgba(168,85,247,0.15)`,iconColor:`#a855f7`,title:`6.1 — Git Branching Strategy (Git Flow)`,children:[(0,b.jsx)(`h4`,{children:`Common Branching Models`}),(0,b.jsxs)(`ul`,{className:`styled-list`,children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Git Flow`}),` — Uses `,(0,b.jsx)(`code`,{children:`main`}),`, `,(0,b.jsx)(`code`,{children:`develop`}),`,`,(0,b.jsx)(`code`,{children:`feature/*`}),`, `,(0,b.jsx)(`code`,{children:`release/*`}),`, and `,(0,b.jsx)(`code`,{children:`hotfix/*`}),` branches. Best for projects with scheduled releases and strict QA stages.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`GitHub Flow`}),` — A simpler model: branch from `,(0,b.jsx)(`code`,{children:`main`}),`, open a PR, review, merge. Ideal for continuous deployment where every merge goes straight to production.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Trunk-Based`}),` — Everyone commits to `,(0,b.jsx)(`code`,{children:`main`}),` (or a single trunk) multiple times a day using feature flags. Favored by high-velocity teams with strong CI/CD pipelines.`]})]}),(0,b.jsx)(`h4`,{children:`Merge vs. Rebase`}),(0,b.jsxs)(`p`,{children:[(0,b.jsx)(`strong`,{children:`Merge`}),` creates a merge commit preserving the full branch topology— great for auditing when a feature was integrated. `,(0,b.jsx)(`strong`,{children:`Rebase`}),` replays your commits onto the tip of the target branch, producing a linear history that's easier to read. The golden rule: `,(0,b.jsx)(`em`,{children:`never rebase commits that have been pushed to a shared branch`}),`. Use rebase for local cleanup; use merge for integrating shared work.`]}),(0,b.jsxs)(ae,{title:`Git Flow Branching Model`,children:[(0,b.jsxs)(oe,{children:[(0,b.jsxs)(E,{variant:`primary`,children:[(0,b.jsx)(`strong`,{children:`main`}),(0,b.jsx)(`small`,{children:`Production`})]}),(0,b.jsx)(D,{children:`←`}),(0,b.jsxs)(E,{variant:`accent`,children:[(0,b.jsx)(`strong`,{children:`develop`}),(0,b.jsx)(`small`,{children:`Integration`})]}),(0,b.jsx)(D,{children:`←`}),(0,b.jsxs)(E,{variant:`success`,children:[(0,b.jsx)(`strong`,{children:`feature/*`}),(0,b.jsx)(`small`,{children:`New Features`})]})]}),(0,b.jsxs)(oe,{style:{marginTop:`1rem`},children:[(0,b.jsxs)(E,{variant:`warning`,children:[(0,b.jsx)(`strong`,{children:`hotfix/*`}),(0,b.jsx)(`small`,{children:`Critical Fixes`})]}),(0,b.jsx)(D,{children:`→`}),(0,b.jsxs)(E,{variant:`primary`,children:[(0,b.jsx)(`strong`,{children:`main`}),(0,b.jsx)(`small`,{children:`& develop`})]})]})]}),(0,b.jsx)(w,{filename:`daily-git-workflow.sh`,language:`Bash`,children:`<span class="cm"># ── Daily Git Workflow ──</span>
...
<span class="fn">git</span> log <span class="op">--oneline</span> <span class="op">--graph</span> <span class="op">--all</span> <span class="op">-15</span>`})]}),(0,b.jsxs)(C,{id:`conventional-commits`,icon:`✍️`,iconBg:`rgba(168,85,247,0.15)`,iconColor:`#a855f7`,title:`6.2 — Conventional Commits & PR Best Practices`,children:[(0,b.jsx)(`h4`,{children:`Commit Message Format`}),(0,b.jsxs)(`p`,{children:[`Conventional Commits follow a structured format:`,(0,b.jsx)(`code`,{children:` type(scope): description`}),`. The `,(0,b.jsx)(`strong`,{children:`type`}),` tells reviewers`,(0,b.jsx)(`em`,{children:`what kind`}),` of change this is. The `,(0,b.jsx)(`strong`,{children:`scope`}),` (optional) narrows it to a module. The `,(0,b.jsx)(`strong`,{children:`description`}),` explains `,(0,b.jsx)(`em`,{children:`what`}),`changed, in imperative mood ("add" not "added"). This format enables automated changelogs, semantic versioning, and makes `,(0,b.jsx)(`code`,{children:`git log`}),` scannable.`]}),(0,b.jsxs)(O,{headers:[`Type`,`Purpose`,`Example`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`feat`})}),(0,b.jsx)(`td`,{children:`A new feature for the user`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`feat(auth): add OAuth2 login flow`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`red`,children:`fix`})}),(0,b.jsx)(`td`,{children:`A bug fix`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`fix(cart): correct quantity calculation`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`refactor`})}),(0,b.jsx)(`td`,{children:`Code restructuring without behavior change`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`refactor(api): extract fetch wrapper`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`perf`})}),(0,b.jsx)(`td`,{children:`Performance improvement`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`perf(list): virtualize long product lists`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`test`})}),(0,b.jsx)(`td`,{children:`Adding or correcting tests`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`test(utils): add date formatting tests`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`docs`})}),(0,b.jsx)(`td`,{children:`Documentation only changes`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`docs(readme): update setup instructions`})})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`gray`,children:`chore`})}),(0,b.jsx)(`td`,{children:`Build, CI, or tooling changes`}),(0,b.jsx)(`td`,{children:(0,b.jsx)(`code`,{children:`chore(deps): bump react to 18.3`})})]})]}),(0,b.jsx)(T,{type:`tip`,title:`PR Review Checklist`,children:(0,b.jsxs)(`ul`,{children:[(0,b.jsx)(`li`,{children:`✅ Code compiles and all tests pass`}),(0,b.jsx)(`li`,{children:`✅ No unnecessary console.log or debugger statements`}),(0,b.jsx)(`li`,{children:`✅ Component follows existing naming conventions`}),(0,b.jsxs)(`li`,{children:[`✅ Complex logic has inline comments explaining `,(0,b.jsx)(`em`,{children:`why`})]}),(0,b.jsx)(`li`,{children:`✅ Accessibility: interactive elements are keyboard-navigable`}),(0,b.jsx)(`li`,{children:`✅ PR description links to the relevant Jira/Linear ticket`})]})})]}),(0,b.jsxs)(C,{id:`automated-checks-cicd`,icon:`🤖`,iconBg:`rgba(168,85,247,0.15)`,iconColor:`#a855f7`,title:`6.3 — Automated Checks (CI/CD)`,children:[(0,b.jsx)(`p`,{children:`Continuous Integration (CI) and Continuous Deployment (CD) are automated processes that ensure code quality and streamline delivery. As a front-end developer, you should understand how to gate your commits and PRs.`}),(0,b.jsxs)(`ul`,{className:`styled-list`,children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Pre-commit Hooks (Husky):`}),` Run ESLint, Prettier, and basic unit tests automatically when a developer runs `,(0,b.jsx)(`code`,{children:`git commit`}),`. If the checks fail, the commit is aborted.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`GitHub Actions / GitLab CI:`}),` When a PR is opened, a remote server runs the full test suite, builds the app, and performs dependency security audits. Reviewers only review code that passes the CI pipeline.`]})]})]}),(0,b.jsxs)(C,{id:`advanced-git-techniques`,icon:`🥷`,iconBg:`rgba(168,85,247,0.15)`,iconColor:`#a855f7`,title:`6.4 — Advanced Git Techniques`,children:[(0,b.jsx)(`p`,{children:`Beyond commit, push, and pull, power users leverage advanced Git commands to untangle messy histories and track down bugs.`}),(0,b.jsx)(w,{filename:`advanced-git.sh`,language:`Bash`,children:`# ── Interactive Rebase ──
...
# Git will checkout a commit in the middle for you to test`})]})]})}function A(){return(0,b.jsxs)(ie,{id:`debugging-troubleshooting`,number:`07`,title:`Debugging, Troubleshooting & Upgrading`,theme:`red`,children:[(0,b.jsx)(`p`,{className:`section-intro`,children:`Every React developer spends a significant portion of their time debugging. The difference between a junior and senior developer isn't the number of bugs they encounter—it's how systematically they diagnose and resolve them. This chapter equips you with the mindset, tools, and patterns to squash bugs efficiently and build resilient applications.`}),(0,b.jsx)(`h3`,{children:`The Debugging Mindset`}),(0,b.jsxs)(`ol`,{className:`styled-list`,children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Reproduce`}),` — Before fixing anything, create a reliable reproduction. Can you trigger the bug consistently? Note the exact steps, browser, and state that cause it. A bug you can't reproduce is a bug you can't verify as fixed.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Isolate`}),` — Narrow the problem to the smallest possible scope. Comment out components, simplify state, or create a minimal reproduction in a fresh project. The goal is to eliminate variables.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Identify`}),` — Read the error messages carefully. Check the component tree in React DevTools. Add strategic `,(0,b.jsx)(`code`,{children:`console.log`}),` statements or breakpoints. Form a hypothesis and test it.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Fix & Verify`}),` — Apply the smallest possible fix. Run the full test suite. Verify the fix in the original reproduction scenario. Write a regression test so this bug never returns.`]})]}),(0,b.jsx)(`h3`,{children:`Common React Bugs`}),(0,b.jsxs)(`div`,{className:`kv-grid`,children:[(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Infinite Re-renders`}),(0,b.jsxs)(`span`,{className:`kv-value`,children:[`Caused by calling `,(0,b.jsx)(`code`,{children:`setState`}),` inside a render or in a `,(0,b.jsx)(`code`,{children:`useEffect`}),`without proper dependencies. The component updates, triggers the effect, which updates state, triggering another render—an infinite loop.`]})]}),(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Stale Closures`}),(0,b.jsx)(`span`,{className:`kv-value`,children:`Event handlers or effects that capture an old value of state or props because the dependency array is missing entries. The function "closes over" a stale snapshot instead of the current value.`})]}),(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Memory Leaks`}),(0,b.jsxs)(`span`,{className:`kv-value`,children:[`Setting state on an unmounted component—typically from an uncleared subscription, timer, or async fetch that resolves after navigation. Always return cleanup functions from `,(0,b.jsx)(`code`,{children:`useEffect`}),`.`]})]})]}),(0,b.jsxs)(C,{id:`react-devtools-profiler`,icon:`🔍`,iconBg:`rgba(239,68,68,0.15)`,iconColor:`#ef4444`,title:`7.1 — React DevTools & Profiler`,children:[(0,b.jsx)(`h4`,{children:`Using the Components Tab`}),(0,b.jsxs)(`ul`,{className:`styled-list`,children:[(0,b.jsx)(`li`,{children:`Inspect the component tree to see the hierarchy, current props, state, and hooks for any component. Click a component to view its details in the right panel.`}),(0,b.jsx)(`li`,{children:`Use the search bar to quickly find components by name. Filter by "rendered by" to trace which parent is rendering a child component.`}),(0,b.jsx)(`li`,{children:`Right-click a component to "Log this component" to the console, "Show source," or "Store as global variable" for live debugging.`})]}),(0,b.jsx)(`h4`,{children:`Using the Profiler Tab`}),(0,b.jsxs)(`p`,{children:[`The Profiler records rendering performance. Click "Record," interact with your app, then stop. You'll see a flame graph of every component that rendered, how long each took, and `,(0,b.jsx)(`em`,{children:`why`}),` it rendered (prop change, state change, or parent re-render). Look for components that render frequently with the same props—those are candidates for `,(0,b.jsx)(`code`,{children:`React.memo()`}),`.`]}),(0,b.jsxs)(O,{headers:[`Tool`,`Purpose`,`When to Use`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`React DevTools Components`})}),(0,b.jsx)(`td`,{children:`Inspect component tree, props, state, hooks`}),(0,b.jsx)(`td`,{children:`Understanding component hierarchy and data flow`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`React DevTools Profiler`})}),(0,b.jsx)(`td`,{children:`Record and analyze rendering performance`}),(0,b.jsx)(`td`,{children:`Identifying unnecessary re-renders and slow components`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`Chrome DevTools Network`})}),(0,b.jsx)(`td`,{children:`Monitor API requests, response times, payloads`}),(0,b.jsx)(`td`,{children:`Debugging API integration, checking request headers`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`Chrome DevTools Performance`})}),(0,b.jsx)(`td`,{children:`CPU profiling, layout thrashing, long tasks`}),(0,b.jsx)(`td`,{children:`Diagnosing jank, slow interactions, large layout shifts`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`console.table()`})}),(0,b.jsx)(`td`,{children:`Display arrays/objects as formatted tables`}),(0,b.jsx)(`td`,{children:`Quick inspection of data structures during development`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`React.StrictMode`})}),(0,b.jsx)(`td`,{children:`Double-invokes effects and renders in development`}),(0,b.jsx)(`td`,{children:`Catching side effects, impure renders, deprecated APIs`})]})]}),(0,b.jsx)(w,{filename:`useWhyDidYouRender.js`,language:`JavaScript`,children:`<span class="kw">import</span> { <span class="fn">useRef</span>, <span class="fn">useEffect</span> } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`})]}),(0,b.jsxs)(C,{id:`error-boundaries-logging`,icon:`🛡️`,iconBg:`rgba(239,68,68,0.15)`,iconColor:`#ef4444`,title:`7.2 — Error Boundaries & Logging`,children:[(0,b.jsxs)(`p`,{children:[`Error boundaries are React class components that catch JavaScript errors anywhere in their child component tree, log those errors, and display a fallback UI instead of crashing the entire application. They act as a `,(0,b.jsx)(`code`,{children:`try/catch`}),` for your component tree—without them, a single thrown error unmounts everything.`]}),(0,b.jsx)(`h4`,{children:`Strategic Placement`}),(0,b.jsxs)(`ul`,{className:`styled-list`,children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Route Level`}),` — Wrap each route in an error boundary so a crash in one page doesn't nuke the sidebar, navigation, or other routes. Users can navigate away from the broken page.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Widget Level`}),` — Wrap individual widgets (charts, feeds, third-party embeds) so a failure in one widget shows a localized error message while the rest of the page continues to function.`]})]}),(0,b.jsx)(w,{filename:`ErrorBoundary.jsx`,language:`JSX`,children:`<span class="kw">import</span> { <span class="type">Component</span> } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`}),(0,b.jsxs)(T,{type:`important`,title:`What Error Boundaries Don't Catch`,children:[(0,b.jsxs)(`p`,{children:[`Error boundaries do `,(0,b.jsx)(`strong`,{children:`not`}),` catch errors in:`]}),(0,b.jsxs)(`ul`,{children:[(0,b.jsxs)(`li`,{children:[`Event handlers — use regular `,(0,b.jsx)(`code`,{children:`try/catch`}),` inside handlers`]}),(0,b.jsxs)(`li`,{children:[`Asynchronous code — `,(0,b.jsx)(`code`,{children:`setTimeout`}),`, `,(0,b.jsx)(`code`,{children:`requestAnimationFrame`}),`, promises`]}),(0,b.jsx)(`li`,{children:`Server-side rendering (SSR)`}),(0,b.jsx)(`li`,{children:`Errors thrown in the error boundary component itself`})]}),(0,b.jsxs)(`p`,{children:[`For async errors, pair error boundaries with global`,(0,b.jsx)(`code`,{children:` window.addEventListener('unhandledrejection', ...)`}),` handlers and an error logging service.`]})]})]}),(0,b.jsxs)(C,{id:`upgrading-react`,icon:`⬆️`,iconBg:`rgba(239,68,68,0.15)`,iconColor:`#ef4444`,title:`7.3 — Upgrading React Versions`,children:[(0,b.jsx)(`p`,{children:`React upgrades are typically smooth, but jumping across major versions (e.g., 17 to 18, or 18 to 19) requires planning. The React team provides codemods to automate many syntax changes.`}),(0,b.jsxs)(`ul`,{className:`styled-list`,children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Read the Changelog:`}),` Pay special attention to breaking changes and deprecation warnings in the console.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Use Strict Mode:`}),` Wrap your app in `,(0,b.jsx)(`code`,{children:`<React.StrictMode>`}),` in development. It surfaces legacy lifecycle methods and unsafe side effects.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Update Dependencies:`}),` Often, third-party libraries break before React itself does. Check compatibility of UI libraries, state managers, and routers.`]})]})]}),(0,b.jsxs)(C,{id:`end-to-end-testing`,icon:`🧪`,iconBg:`rgba(239,68,68,0.15)`,iconColor:`#ef4444`,title:`7.4 — End-to-End Testing (Cypress/Playwright)`,children:[(0,b.jsx)(`p`,{children:`Unit tests check components in isolation, but bugs often hide in the integration between components. End-to-End (E2E) tests spin up a real browser, click buttons, and verify the UI behaves correctly from a user's perspective.`}),(0,b.jsx)(w,{filename:`login.spec.js`,language:`JavaScript`,children:`// Cypress Example
describe('Login Flow', () => {
...
});`})]})]})}function pe(){return(0,b.jsxs)(ie,{id:`skills-expertise-deep-dive`,number:`08`,title:`Skills & Expertise Deep Dive`,theme:`green`,children:[(0,b.jsx)(`p`,{className:`section-intro`,children:`This chapter takes a comprehensive look at the core skills every React developer needs to master. From JavaScript fundamentals to advanced state management patterns to build tooling—these are the competencies that define your effectiveness on a professional React team.`}),(0,b.jsx)(`h3`,{children:`T-Shaped Developer`}),(0,b.jsxs)(`p`,{children:[`The most valuable developers are `,(0,b.jsx)(`strong`,{children:`T-shaped`}),`: they have broad knowledge across the entire stack (the horizontal bar) and deep expertise in one or two areas (the vertical bar). For a React developer, the horizontal bar spans HTML, CSS, JavaScript, testing, accessibility, networking, and DevOps. The vertical bar is your specialization—maybe it's state management architecture, performance optimization, or design system engineering. Invest in both dimensions.`]}),(0,b.jsxs)(C,{id:`javascript-es6-mastery`,icon:`⚡`,iconBg:`rgba(34,197,94,0.15)`,iconColor:`#22c55e`,title:`8.1 — JavaScript ES6+ Mastery`,children:[(0,b.jsxs)(`p`,{children:[`React is fundamentally JavaScript. Every JSX expression compiles to a`,(0,b.jsx)(`code`,{children:` React.createElement()`}),` call. Every hook is a function. Every component is a function (or class). If your JavaScript foundations are weak, React will feel like magic. When they're strong, React feels like a natural extension of the language.`]}),(0,b.jsx)(`h4`,{children:`Crucial JavaScript Concepts for React`}),(0,b.jsxs)(`div`,{className:`kv-grid`,children:[(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Immutability`}),(0,b.jsxs)(`span`,{className:`kv-value`,children:[`React relies on reference equality to detect changes. Mutating objects or arrays in place bypasses React's change detection. Always create new references with spread syntax, `,(0,b.jsx)(`code`,{children:`.map()`}),`, or `,(0,b.jsx)(`code`,{children:`.filter()`}),`.`]})]}),(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Closures`}),(0,b.jsxs)(`span`,{className:`kv-value`,children:[`Every event handler and `,(0,b.jsx)(`code`,{children:`useEffect`}),` callback forms a closure over its surrounding scope. Understanding closures is essential for avoiding stale state bugs and for writing correct dependency arrays.`]})]}),(0,b.jsxs)(`div`,{className:`kv-item`,children:[(0,b.jsx)(`span`,{className:`kv-label`,children:`Truthiness`}),(0,b.jsxs)(`span`,{className:`kv-value`,children:[`JSX conditional rendering relies on JavaScript's truthy/falsy rules.`,(0,b.jsx)(`code`,{children:` {count && <List />}`}),` renders `,(0,b.jsx)(`code`,{children:`0`}),` when count is zero because `,(0,b.jsx)(`code`,{children:`0`}),` is falsy but still a renderable value. Use explicit comparisons: `,(0,b.jsx)(`code`,{children:`{count > 0 && <List />}`}),`.`]})]})]}),(0,b.jsx)(w,{filename:`essential-es6-patterns.js`,language:`JavaScript`,children:`<span class="cm">// ── 1. Destructuring ──</span>
...
<span class="kw">import</span> <span class="fn">MyComponent</span>, { <span class="attr">API_URL</span> } <span class="kw">from</span> <span class="str">'./MyComponent'</span>;`})]}),(0,b.jsxs)(C,{id:`react-hooks-state-management`,icon:`🪝`,iconBg:`rgba(34,197,94,0.15)`,iconColor:`#22c55e`,title:`8.2 — React Hooks & State Management`,children:[(0,b.jsx)(`p`,{children:`Hooks revolutionized React by allowing function components to manage state, side effects, context, and refs—capabilities previously reserved for class components. They promote composition over inheritance and make logic reusable through custom hooks.`}),(0,b.jsx)(`h4`,{children:`Mental Model`}),(0,b.jsxs)(`p`,{children:[`Think of a component as a function that runs on every render. Hooks are "memory slots" attached to that component instance. `,(0,b.jsx)(`code`,{children:`useState`}),`gives you a slot for a value that persists across renders.`,(0,b.jsx)(`code`,{children:` useEffect`}),` gives you a slot for a side effect that runs after the DOM updates. `,(0,b.jsx)(`code`,{children:`useRef`}),` gives you a mutable box that doesn't trigger re-renders. The order you call hooks determines which slot you're accessing—that's why hooks must always be called in the same order (no conditionals, no loops).`]}),(0,b.jsxs)(O,{headers:[`Hook`,`Purpose`,`Common Use Case`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`useState`})}),(0,b.jsx)(`td`,{children:`Manage simple local state`}),(0,b.jsx)(`td`,{children:`Form inputs, toggles, counters`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`useEffect`})}),(0,b.jsx)(`td`,{children:`Side effects after render`}),(0,b.jsx)(`td`,{children:`API calls, subscriptions, DOM manipulation`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`useContext`})}),(0,b.jsx)(`td`,{children:`Access context values`}),(0,b.jsx)(`td`,{children:`Theme, auth, locale without prop drilling`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`useReducer`})}),(0,b.jsx)(`td`,{children:`Complex state with actions`}),(0,b.jsx)(`td`,{children:`Forms with many fields, state machines`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`useRef`})}),(0,b.jsx)(`td`,{children:`Mutable ref that persists across renders`}),(0,b.jsx)(`td`,{children:`DOM refs, previous values, timers`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`useId`})}),(0,b.jsx)(`td`,{children:`Generate unique IDs for accessibility`}),(0,b.jsx)(`td`,{children:`Linking labels to inputs, ARIA attributes`})]})]}),(0,b.jsx)(w,{filename:`useFormReducer.js`,language:`JavaScript`,children:`<span class="kw">import</span> { <span class="fn">useReducer</span>, <span class="fn">useCallback</span> } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`}),(0,b.jsx)(w,{filename:`userSlice.js`,language:`JavaScript`,children:`<span class="kw">import</span> { <span class="fn">createSlice</span>, <span class="fn">createAsyncThunk</span> } <span class="kw">from</span> <span class="str">'@reduxjs/toolkit'</span>;
...
<span class="kw">export default</span> <span class="attr">userSlice</span>.<span class="attr">reducer</span>;`}),(0,b.jsx)(w,{filename:`AuthContext.jsx`,language:`JSX`,children:`<span class="kw">import</span> { <span class="fn">createContext</span>, <span class="fn">useContext</span>, <span class="fn">useReducer</span> } <span class="kw">from</span> <span class="str">'react'</span>;
...
}`}),(0,b.jsx)(T,{type:`note`,title:`Redux vs. Context API — Decision Guide`,children:(0,b.jsxs)(`p`,{children:[`Use `,(0,b.jsx)(`strong`,{children:`Context API`}),` for low-frequency updates shared across many components (theme, locale, auth). Use `,(0,b.jsx)(`strong`,{children:`Redux Toolkit`}),` when you have complex, frequently-changing state with many actions, need middleware (thunks, sagas), require time-travel debugging, or your state graph has many interdependent slices. For server state (API data), consider `,(0,b.jsx)(`strong`,{children:`React Query`}),` or`,(0,b.jsx)(`strong`,{children:` SWR`}),`—they handle caching, deduplication, and revalidation out of the box.`]})})]}),(0,b.jsxs)(C,{id:`build-tools`,icon:`🔧`,iconBg:`rgba(34,197,94,0.15)`,iconColor:`#22c55e`,title:`8.3 — Build Tools: Webpack, Babel & Vite`,children:[(0,b.jsx)(`h4`,{children:`The Shift from Webpack to Vite`}),(0,b.jsx)(`p`,{children:`For years, Webpack was the de facto bundler for React projects. It's powerful and endlessly configurable—but that power comes at the cost of complexity and slow cold starts. Webpack bundles your entire application before serving it, which means even a small change requires re-processing thousands of modules.`}),(0,b.jsx)(`p`,{children:`Vite takes a fundamentally different approach. In development, it serves files over native ES modules—your browser does the bundling. Only the file you changed is hot-replaced, making HMR near-instant regardless of project size. For production, Vite uses Rollup under the hood, producing optimized bundles with tree-shaking, code splitting, and asset hashing.`}),(0,b.jsxs)(O,{headers:[`Tool`,`Role`,`Key Feature`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`Webpack`})}),(0,b.jsx)(`td`,{children:`Module bundler`}),(0,b.jsx)(`td`,{children:`Extremely configurable; vast plugin ecosystem`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`Babel`})}),(0,b.jsx)(`td`,{children:`JavaScript compiler`}),(0,b.jsx)(`td`,{children:`Transpiles JSX and modern JS to browser-compatible code`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`Vite`})}),(0,b.jsx)(`td`,{children:`Dev server + bundler`}),(0,b.jsx)(`td`,{children:`Instant HMR via native ESM; Rollup for production`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`ESLint`})}),(0,b.jsx)(`td`,{children:`Linter`}),(0,b.jsx)(`td`,{children:`Catches errors and enforces code style before runtime`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`Prettier`})}),(0,b.jsx)(`td`,{children:`Code formatter`}),(0,b.jsx)(`td`,{children:`Opinionated formatting; eliminates style debates`})]})]}),(0,b.jsx)(w,{filename:`vite.config.js`,language:`JavaScript`,children:`<span class="kw">import</span> { <span class="fn">defineConfig</span> } <span class="kw">from</span> <span class="str">'vite'</span>;
...
});`}),(0,b.jsx)(w,{filename:`.eslintrc.json`,language:`JSON`,children:`{
...
}`})]}),(0,b.jsxs)(C,{id:`testing-strategy`,icon:`🧪`,iconBg:`rgba(34,197,94,0.15)`,iconColor:`#22c55e`,title:`8.4 — Testing Strategy`,children:[(0,b.jsx)(`p`,{children:`A robust testing strategy gives you the confidence to refactor and deploy. In the React ecosystem, the standard stack involves Jest (or Vitest) for test running/assertions, and React Testing Library (RTL) for rendering components.`}),(0,b.jsxs)(`ul`,{className:`styled-list`,children:[(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Unit Tests:`}),` Test pure functions, utilities, and custom hooks in isolation.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`Integration Tests (RTL):`}),` Render a component with its children, interact with the DOM (click buttons, type in inputs), and assert that the UI updates correctly. Avoid testing implementation details (like state variables); test the user experience instead.`]}),(0,b.jsxs)(`li`,{children:[(0,b.jsx)(`strong`,{children:`End-to-End Tests:`}),` Use tools like Playwright or Cypress to run your full application in a real browser, connecting to real (or closely mocked) backends.`]})]})]}),(0,b.jsxs)(C,{id:`typescript-basics`,icon:`🟦`,iconBg:`rgba(34,197,94,0.15)`,iconColor:`#22c55e`,title:`8.5 — TypeScript Basics for React`,children:[(0,b.jsx)(`p`,{children:`While this guide uses JavaScript for simplicity, TypeScript has become the industry standard for enterprise React applications. TypeScript adds static typing to JavaScript, catching errors at compile time rather than runtime.`}),(0,b.jsx)(`p`,{children:`When using TypeScript with React, you define interfaces for your component props and state. This provides excellent autocompletion in your IDE and ensures you don't accidentally pass a string where a number is expected.`})]}),(0,b.jsx)(`h3`,{children:`Quick Reference: Skills Proficiency Matrix`}),(0,b.jsxs)(O,{headers:[`Skill Area`,`Junior`,`Mid-Level`,`Senior`],children:[(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`JavaScript`})}),(0,b.jsx)(`td`,{children:`ES6 basics, array methods, promises`}),(0,b.jsx)(`td`,{children:`Closures, prototypes, generators, proxies`}),(0,b.jsx)(`td`,{children:`Engine internals, memory model, perf tuning`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`React Core`})}),(0,b.jsx)(`td`,{children:`Components, props, useState, useEffect`}),(0,b.jsx)(`td`,{children:`Custom hooks, memo, context, suspense`}),(0,b.jsx)(`td`,{children:`Concurrent features, RSC, reconciler knowledge`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`State Management`})}),(0,b.jsx)(`td`,{children:`useState, prop drilling`}),(0,b.jsx)(`td`,{children:`useReducer, Context, Redux basics`}),(0,b.jsx)(`td`,{children:`Redux middleware, Zustand, Jotai, XState`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`Styling`})}),(0,b.jsx)(`td`,{children:`CSS basics, flexbox, class toggling`}),(0,b.jsx)(`td`,{children:`CSS Grid, custom properties, responsive design`}),(0,b.jsx)(`td`,{children:`Design systems, CSS-in-JS perf, animation APIs`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`Testing`})}),(0,b.jsx)(`td`,{children:`Basic unit tests with Jest`}),(0,b.jsx)(`td`,{children:`React Testing Library, mocking, integration tests`}),(0,b.jsx)(`td`,{children:`E2E (Playwright), visual regression, CI pipelines`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`orange`,children:`Build Tools`})}),(0,b.jsx)(`td`,{children:`Uses CRA/Vite defaults`}),(0,b.jsx)(`td`,{children:`Custom Vite config, ESLint rules, path aliases`}),(0,b.jsx)(`td`,{children:`Webpack internals, custom plugins, monorepo tooling`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`purple`,children:`Version Control`})}),(0,b.jsx)(`td`,{children:`add, commit, push, basic branching`}),(0,b.jsx)(`td`,{children:`Rebase, cherry-pick, conventional commits`}),(0,b.jsx)(`td`,{children:`Git internals, bisect, reflog, custom hooks`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`red`,children:`Performance`})}),(0,b.jsx)(`td`,{children:`Aware of re-render concept`}),(0,b.jsx)(`td`,{children:`Profiler, lazy loading, code splitting`}),(0,b.jsx)(`td`,{children:`Bundle analysis, runtime profiling, WASM integration`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`green`,children:`Accessibility`})}),(0,b.jsx)(`td`,{children:`Alt text, semantic HTML`}),(0,b.jsx)(`td`,{children:`ARIA roles, keyboard nav, focus management`}),(0,b.jsx)(`td`,{children:`Screen reader testing, WCAG audits, a11y architecture`})]}),(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{children:(0,b.jsx)(k,{variant:`blue`,children:`Soft Skills`})}),(0,b.jsx)(`td`,{children:`Asks questions, follows guidance`}),(0,b.jsx)(`td`,{children:`Code reviews, mentoring juniors, technical writing`}),(0,b.jsx)(`td`,{children:`Architecture decisions, stakeholder communication, hiring`})]})]})]})}function me(){return(0,b.jsxs)(ie,{id:`react-19-features`,number:`09`,title:`React 19 & The Future`,theme:`teal`,children:[(0,b.jsx)(`p`,{className:`section-intro`,children:`React 19 brings some of the most significant architectural changes to the library since Hooks were introduced. It focuses on simplifying data fetching, handling async transitions, and moving heavy computations out of the developer's hands and into the compiler. This chapter covers what's new and how to prepare your codebase for the future.`}),(0,b.jsxs)(C,{id:`react-compiler`,icon:`⚙️`,iconBg:`rgba(20,184,166,0.15)`,iconColor:`#14b8a6`,title:`9.1 — React Compiler`,children:[(0,b.jsxs)(`p`,{children:[`Historically, React developers had to manually optimize renders using `,(0,b.jsx)(`code`,{children:`useMemo`}),`, `,(0,b.jsx)(`code`,{children:`useCallback`}),`, and `,(0,b.jsx)(`code`,{children:`React.memo`}),`. The React Compiler changes this fundamentally. It automatically analyzes your code and applies memoization where it's needed, skipping unnecessary re-renders.`]}),(0,b.jsx)(T,{type:`tip`,title:`What this means for you`,children:(0,b.jsxs)(`p`,{children:[`You can write idiomatic React without worrying about performance micro-optimizations. No more wrapping every function in `,(0,b.jsx)(`code`,{children:`useCallback`}),` or primitive values in `,(0,b.jsx)(`code`,{children:`useMemo`}),` just to prevent a child component from re-rendering.`]})})]}),(0,b.jsxs)(C,{id:`server-actions`,icon:`🚀`,iconBg:`rgba(20,184,166,0.15)`,iconColor:`#14b8a6`,title:`9.2 — Server Actions`,children:[(0,b.jsx)(`p`,{children:`Server Actions allow you to run asynchronous functions directly on the server, tightly integrated with React's form submissions and transitions. They eliminate the need for writing boilerplate API endpoints for simple data mutations.`}),(0,b.jsx)(w,{filename:`ServerActionExample.js`,language:`javascript`,children:`// app/actions.js
'use server'
...
}`})]}),(0,b.jsxs)(C,{id:`use-hook`,icon:`🎣`,iconBg:`rgba(20,184,166,0.15)`,iconColor:`#14b8a6`,title:`9.3 — The new 'use' Hook`,children:[(0,b.jsxs)(`p`,{children:[`React 19 introduces a new primitive hook simply called `,(0,b.jsx)(`code`,{children:`use`}),`. It allows you to read the value of a Promise or Context directly inside a component's render function, integrating perfectly with Suspense.`]}),(0,b.jsx)(T,{type:`warning`,title:`Difference from other hooks`,children:(0,b.jsxs)(`p`,{children:[`Unlike other hooks, `,(0,b.jsx)(`code`,{children:`use`}),` can be called conditionally (e.g., inside an `,(0,b.jsx)(`code`,{children:`if`}),` statement or loop), making it extremely flexible for dynamic data requirements.`]})}),(0,b.jsx)(w,{filename:`UseHookExample.jsx`,language:`jsx`,children:`import { use, Suspense } from 'react';
...
export default function App() {
...
}`})]}),(0,b.jsxs)(C,{id:`document-metadata`,icon:`📄`,iconBg:`rgba(20,184,166,0.15)`,iconColor:`#14b8a6`,title:`9.4 — Built-in Document Metadata`,children:[(0,b.jsxs)(`p`,{children:[`Managing `,(0,b.jsx)(`code`,{children:`<title>`}),`, `,(0,b.jsx)(`code`,{children:`<meta>`}),`, and `,(0,b.jsx)(`code`,{children:`<link>`}),` tags used to require third-party libraries like `,(0,b.jsx)(`code`,{children:`react-helmet`}),`. React 19 natively supports rendering these elements in any component, automatically hoisting them to the document `,(0,b.jsx)(`code`,{children:`<head>`}),`.`]}),(0,b.jsx)(w,{filename:`MetadataExample.jsx`,language:`jsx`,children:`export default function BlogPost({ post }) {
  return (
    <article>
...
}`})]})]})}var he=()=>(0,b.jsxs)(C,{id:`dsa-arrays`,title:`10.1 — Arrays & Hashing`,icon:`📦`,children:[(0,b.jsxs)(`h3`,{children:[`Two Sum `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsxs)(`p`,{children:[`Given an array of integers `,(0,b.jsx)(`code`,{children:`nums`}),` and an integer `,(0,b.jsx)(`code`,{children:`target`}),`, return indices of the two numbers such that they add up to `,(0,b.jsx)(`code`,{children:`target`}),`.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function twoSum(nums, target) {
  ...
  return [];
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function twoSum(nums, target) {
  const map = new Map();
  for (let i = 0; i < nums.length; i++) {
  ...
  return [];
}`})]}),(0,b.jsx)(`h3`,{children:`Contains Duplicate`}),(0,b.jsxs)(`p`,{children:[`Given an integer array `,(0,b.jsx)(`code`,{children:`nums`}),`, return `,(0,b.jsx)(`code`,{children:`true`}),` if any value appears at least twice in the array, and return `,(0,b.jsx)(`code`,{children:`false`}),` if every element is distinct.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function containsDuplicate(nums) {
  for (let i = 0; i < nums.length; i++) {
    for (let j = i + 1; j < nums.length; j++) {
      if (nums[i] === nums[j]) {
        return true;
  ...
  return false;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function containsDuplicate(nums) {
  const set = new Set();
  ...
  return false;
}`})]}),(0,b.jsxs)(`h3`,{children:[`Group Anagrams `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Given an array of strings, group the anagrams together. You can return the answer in any order.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach (Sorting)`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n * k log k) | Space Complexity: O(n * k)`}),(0,b.jsx)(w,{language:`javascript`,children:`function groupAnagrams(strs) {
  const map = {};
  for (let str of strs) {
...
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Character Frequency)`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n * k) | Space Complexity: O(n * k)`}),(0,b.jsx)(w,{language:`javascript`,children:`function groupAnagrams(strs) {
  const map = {};
  for (let str of strs) {
  ...
  return Object.values(map);
}`})]}),(0,b.jsxs)(`h3`,{children:[`Product of Array Except Self `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsxs)(`p`,{children:[`Given an integer array `,(0,b.jsx)(`code`,{children:`nums`}),`, return an array `,(0,b.jsx)(`code`,{children:`answer`}),` such that `,(0,b.jsx)(`code`,{children:`answer[i]`}),` is equal to the product of all the elements of `,(0,b.jsx)(`code`,{children:`nums`}),` except `,(0,b.jsx)(`code`,{children:`nums[i]`}),`. You must write an algorithm that runs in O(n) time and without using the division operation.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function productExceptSelf(nums) {
  const res = [];
  for (let i = 0; i < nums.length; i++) {
    let product = 1;
  ...
  return res;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(1) (excluding output array)`}),(0,b.jsx)(w,{language:`javascript`,children:`function productExceptSelf(nums) {
  const res = [];
  let prefix = 1;
  for (let i = 0; i < nums.length; i++) {
    res[i] = prefix;
  ...
  return res;
}`})]}),(0,b.jsx)(`h3`,{children:`Top K Frequent Elements`}),(0,b.jsxs)(`p`,{children:[`Given an integer array `,(0,b.jsx)(`code`,{children:`nums`}),` and an integer `,(0,b.jsx)(`code`,{children:`k`}),`, return the `,(0,b.jsx)(`code`,{children:`k`}),` most frequent elements. You may return the answer in any order.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach (Sorting)`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n log n) | Space Complexity: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function topKFrequent(nums, k) {
  const map = new Map();
  for (let num of nums) {
...
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Bucket Sort)`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function topKFrequent(nums, k) {
  const map = new Map();
  for (let num of nums) {
    map.set(num, (map.get(num) || 0) + 1);
  }
  ...
  return res;
}`})]}),(0,b.jsx)(`h3`,{children:`Longest Consecutive Sequence`}),(0,b.jsxs)(`p`,{children:[`Given an unsorted array of integers `,(0,b.jsx)(`code`,{children:`nums`}),`, return the length of the longest consecutive elements sequence. You must write an algorithm that runs in O(n) time.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach (Sorting)`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n log n) | Space Complexity: O(1) or O(n) depending on sort`}),(0,b.jsx)(w,{language:`javascript`,children:`function longestConsecutive(nums) {
...
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function longestConsecutive(nums) {
  ...
  return longest;
}`})]})]}),ge=()=>(0,b.jsxs)(C,{id:`dsa-two-pointers`,title:`10.2 — Two Pointers`,icon:`👉`,children:[(0,b.jsxs)(`h3`,{children:[`Valid Palindrome `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`A phrase is a palindrome if, after converting all uppercase letters into lowercase letters and removing all non-alphanumeric characters, it reads the same forward and backward.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function isPalindrome(s) {
  const cleanStr = s.replace(/[^a-zA-Z0-9]/g, '').toLowerCase();
  const reversedStr = cleanStr.split('').reverse().join('');
  return cleanStr === reversedStr;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function isPalindrome(s) {
  let left = 0;
  ...
  return true;
}`})]}),(0,b.jsx)(`h3`,{children:`Two Sum II - Input Array Is Sorted`}),(0,b.jsxs)(`p`,{children:[`Given a 1-indexed array of integers `,(0,b.jsx)(`code`,{children:`numbers`}),` that is already sorted in non-decreasing order, find two numbers such that they add up to a specific `,(0,b.jsx)(`code`,{children:`target`}),` number. Return the indices (1-indexed).`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function twoSum(numbers, target) {
  ...
  return [];
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function twoSum(numbers, target) {
  let left = 0;
  ...
  return [];
}`})]}),(0,b.jsxs)(`h3`,{children:[`3Sum `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsxs)(`p`,{children:[`Given an integer array nums, return all the triplets `,(0,b.jsx)(`code`,{children:`[nums[i], nums[j], nums[k]]`}),` such that `,(0,b.jsx)(`code`,{children:`i != j`}),`, `,(0,b.jsx)(`code`,{children:`i != k`}),`, and `,(0,b.jsx)(`code`,{children:`j != k`}),`, and `,(0,b.jsx)(`code`,{children:`nums[i] + nums[j] + nums[k] == 0`}),`. The solution set must not contain duplicate triplets.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n³) | Space Complexity: O(n) (for storing sets)`}),(0,b.jsx)(w,{language:`javascript`,children:`function threeSum(nums) {
  const result = [];
  const set = new Set();
  ...
  return result;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(1) or O(n) (depending on sorting algorithm)`}),(0,b.jsx)(w,{language:`javascript`,children:`function threeSum(nums) {
  const res = [];
  nums.sort((a, b) => a - b);
  ...
  return res;
}`})]}),(0,b.jsx)(`h3`,{children:`Container With Most Water`}),(0,b.jsxs)(`p`,{children:[`Given an integer array `,(0,b.jsx)(`code`,{children:`height`}),` of length `,(0,b.jsx)(`code`,{children:`n`}),`, find two lines that together with the x-axis form a container, such that the container contains the most water. Return the maximum amount of water a container can store.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function maxArea(height) {
  let maxArea = 0;
  ...
  return maxArea;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function maxArea(height) {
  let maxArea = 0;
  let left = 0;
  ...
  return maxArea;
}`})]}),(0,b.jsx)(`h3`,{children:`Trapping Rain Water`}),(0,b.jsxs)(`p`,{children:[`Given `,(0,b.jsx)(`code`,{children:`n`}),` non-negative integers representing an elevation map where the width of each bar is 1, compute how much water it can trap after raining.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function trap(height) {
  let res = 0;
  for (let i = 0; i < height.length; i++) {
  ...
  return res;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function trap(height) {
  ...
  return res;
}`})]})]}),_e=()=>(0,b.jsxs)(C,{id:`dsa-sliding-window`,title:`10.3 — Sliding Window`,icon:`🪟`,children:[(0,b.jsx)(`h3`,{children:`Best Time to Buy and Sell Stock`}),(0,b.jsxs)(`p`,{children:[`You are given an array `,(0,b.jsx)(`code`,{children:`prices`}),` where `,(0,b.jsx)(`code`,{children:`prices[i]`}),` is the price of a given stock on the ith day. You want to maximize your profit by choosing a single day to buy one stock and choosing a different day in the future to sell that stock.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function maxProfit(prices) {
  let maxProfit = 0;
  ...
  return maxProfit;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function maxProfit(prices) {
  let left = 0; // buy
  let right = 1; // sell
  let maxProfit = 0;
  ...
  return maxProfit;
}`})]}),(0,b.jsxs)(`h3`,{children:[`Longest Substring Without Repeating Characters `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsxs)(`p`,{children:[`Given a string `,(0,b.jsx)(`code`,{children:`s`}),`, find the length of the longest substring without repeating characters.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n³) | Space Complexity: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function lengthOfLongestSubstring(s) {
  const isUnique = (str) => {
    const set = new Set();
    for (let char of str) {
  ...
  return maxLength;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function lengthOfLongestSubstring(s) {
  const set = new Set();
  let left = 0;
  let maxLength = 0;
  ...
  return maxLength;
}`})]}),(0,b.jsx)(`h3`,{children:`Longest Repeating Character Replacement`}),(0,b.jsxs)(`p`,{children:[`You are given a string `,(0,b.jsx)(`code`,{children:`s`}),` and an integer `,(0,b.jsx)(`code`,{children:`k`}),`. You can choose any character of the string and change it to any other uppercase English character. You can perform this operation at most `,(0,b.jsx)(`code`,{children:`k`}),` times. Return the length of the longest substring containing the same letter you can get after performing the above operations.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function characterReplacement(s, k) {
  let maxLength = 0;
  ...
  return maxLength;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(1) (26 characters)`}),(0,b.jsx)(w,{language:`javascript`,children:`function characterReplacement(s, k) {
  const count = {};
  let res = 0;
  let left = 0;
  let maxf = 0;
  ...
  return res;
}`})]}),(0,b.jsx)(`h3`,{children:`Permutation in String`}),(0,b.jsxs)(`p`,{children:[`Given two strings `,(0,b.jsx)(`code`,{children:`s1`}),` and `,(0,b.jsx)(`code`,{children:`s2`}),`, return `,(0,b.jsx)(`code`,{children:`true`}),` if `,(0,b.jsx)(`code`,{children:`s2`}),` contains a permutation of `,(0,b.jsx)(`code`,{children:`s1`}),`, or `,(0,b.jsx)(`code`,{children:`false`}),` otherwise.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n * (m log m)) where m is s1 length, n is s2 length | Space Complexity: O(m)`}),(0,b.jsx)(w,{language:`javascript`,children:`function checkInclusion(s1, s2) {
  ...
  return false;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n) | Space Complexity: O(1) (26 characters)`}),(0,b.jsx)(w,{language:`javascript`,children:`function checkInclusion(s1, s2) {
  ...
  return matches === 26;
}`})]}),(0,b.jsx)(`h3`,{children:`Minimum Window Substring`}),(0,b.jsxs)(`p`,{children:[`Given two strings `,(0,b.jsx)(`code`,{children:`s`}),` and `,(0,b.jsx)(`code`,{children:`t`}),` of lengths `,(0,b.jsx)(`code`,{children:`m`}),` and `,(0,b.jsx)(`code`,{children:`n`}),` respectively, return the minimum window substring of `,(0,b.jsx)(`code`,{children:`s`}),` such that every character in `,(0,b.jsx)(`code`,{children:`t`}),` (including duplicates) is included in the window. If there is no such substring, return the empty string `,(0,b.jsx)(`code`,{children:`""`}),`.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Brute Force Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(n²) | Space Complexity: O(t)`}),(0,b.jsx)(w,{language:`javascript`,children:`function minWindow(s, t) {
  const getCount = (str) => {
    const map = {};
  ...
  return minStr;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach`}),(0,b.jsx)(`p`,{children:`Time Complexity: O(m + n) | Space Complexity: O(m + n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function minWindow(s, t) {
  if (t === "") return "";
...
}`})]})]}),ve=()=>(0,b.jsxs)(C,{id:`dsa-stack`,title:`10.4 — Stack`,icon:`📚`,children:[(0,b.jsxs)(`h3`,{children:[`Valid Parentheses `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsxs)(`p`,{children:[`Given a string containing just the characters '(', ')', '`,`, `,`', '[' and ']', determine if the input string is valid.`]}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (String Replace)`}),(0,b.jsxs)(`p`,{children:[`Repeatedly replace valid pairs "()", "`,`", "[]" until no more pairs can be found. Time: O(n^2), Space: O(n)`]}),(0,b.jsx)(w,{language:`javascript`,children:`function isValid(s) {
  while (s.includes('()') || s.includes('{}') || s.includes('[]')) {
    s = s.replace('()', '').replace('{}', '').replace('[]', '');
  }
  return s === '';
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Stack)`}),(0,b.jsx)(`p`,{children:`Use a stack to keep track of opening brackets. When a closing bracket is encountered, check if it matches the top of the stack. Time: O(n), Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function isValid(s) {
  const stack = [];
  const map = {
    ')': '(',
    '}': '{',
...
}`})]}),(0,b.jsx)(`h3`,{children:`Min Stack`}),(0,b.jsx)(`p`,{children:`Design a stack that supports push, pop, top, and retrieving the minimum element in constant time.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Search for Min)`}),(0,b.jsx)(`p`,{children:`Keep a standard stack. When getMin() is called, iterate through the stack to find the minimum. Time: O(1) push/pop, O(n) getMin. Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`class MinStack {
  constructor() {
    this.stack = [];
  }
  push(val) {
...
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Two Stacks / Tuple)`}),(0,b.jsx)(`p`,{children:`Store pairs of [value, current_min] in the stack to retrieve the minimum in O(1) time. Time: O(1) all ops, Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`class MinStack {
  constructor() {
    this.stack = [];
  }
  push(val) {
...
}`})]}),(0,b.jsxs)(`h3`,{children:[`Daily Temperatures `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Given an array of temperatures, return an array such that answer[i] is the number of days you have to wait after the ith day to get a warmer temperature.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Brute Force)`}),(0,b.jsx)(`p`,{children:`For each day, iterate forward to find the next warmer day. Time: O(n^2), Space: O(1) extra space.`}),(0,b.jsx)(w,{language:`javascript`,children:`function dailyTemperatures(temperatures) {
  ...
  return res;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Monotonic Stack)`}),(0,b.jsx)(`p`,{children:`Use a stack to keep track of indices. If we see a warmer temperature, we pop indices from the stack and calculate the difference. Time: O(n), Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function dailyTemperatures(temperatures) {
  const res = new Array(temperatures.length).fill(0);
  ...
  return res;
}`})]}),(0,b.jsx)(`h3`,{children:`Next Greater Element`}),(0,b.jsx)(`p`,{children:`Given two arrays, find the next greater element for each element of the first array in the second array.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Brute Force)`}),(0,b.jsx)(`p`,{children:`For each element in nums1, find its position in nums2, then scan right to find the next greater. Time: O(n * m), Space: O(1) extra space.`}),(0,b.jsx)(w,{language:`javascript`,children:`function nextGreaterElement(nums1, nums2) {
...
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Monotonic Stack + Hash Map)`}),(0,b.jsx)(`p`,{children:`Use a monotonic stack to find the next greater elements for all of nums2, store results in a map, and quickly lookup for nums1. Time: O(n + m), Space: O(m)`}),(0,b.jsx)(w,{language:`javascript`,children:`function nextGreaterElement(nums1, nums2) {
  const map = new Map();
  const stack = [];
...
}`})]}),(0,b.jsx)(`h3`,{children:`Largest Rectangle in Histogram`}),(0,b.jsx)(`p`,{children:`Given an array of integers representing the histogram's bar height, return the area of the largest rectangle.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Brute Force)`}),(0,b.jsx)(`p`,{children:`For each pair of bars, find the minimum height between them and calculate area. Time: O(n^2), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function largestRectangleArea(heights) {
  let maxArea = 0;
  ...
  return maxArea;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Monotonic Stack)`}),(0,b.jsx)(`p`,{children:`Use a stack to track indices of increasing bar heights. When a shorter bar is found, calculate areas for bars in the stack. Time: O(n), Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function largestRectangleArea(heights) {
  let maxArea = 0;
  const stack = []; // stores indices
  ...
  return maxArea;
}`})]})]}),ye=()=>(0,b.jsxs)(C,{id:`dsa-binary-search`,title:`10.5 — Binary Search`,icon:`🔍`,children:[(0,b.jsxs)(`h3`,{children:[`Binary Search `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Given an array of integers nums which is sorted in ascending order, and an integer target, write a function to search target in nums.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Linear Search)`}),(0,b.jsx)(`p`,{children:`Iterate through the array one by one until the target is found. Time: O(n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function search(nums, target) {
  for (let i = 0; i < nums.length; i++) {
    if (nums[i] === target) return i;
  }
  return -1;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Binary Search)`}),(0,b.jsx)(`p`,{children:`Compare target with middle element, eliminate half the search space based on result. Time: O(log n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function search(nums, target) {
  let left = 0;
  let right = nums.length - 1;
  ...
  return -1;
}`})]}),(0,b.jsxs)(`h3`,{children:[`Search in Rotated Sorted Array `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Search for a target value in a sorted array that has been rotated at some pivot.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Linear Search)`}),(0,b.jsx)(`p`,{children:`Scan through the entire array. Time: O(n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function search(nums, target) {
  return nums.indexOf(target);
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Modified Binary Search)`}),(0,b.jsx)(`p`,{children:`Determine which half is properly sorted, and check if target falls within that sorted half. Time: O(log n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function search(nums, target) {
  ...
  return -1;
}`})]}),(0,b.jsx)(`h3`,{children:`Find Minimum in Rotated Sorted Array`}),(0,b.jsx)(`p`,{children:`Find the minimum element in a sorted array that has been rotated.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Linear Search)`}),(0,b.jsx)(`p`,{children:`Iterate and find the minimum value. Time: O(n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function findMin(nums) {
  return Math.min(...nums);
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Binary Search)`}),(0,b.jsx)(`p`,{children:`Look for the inflection point where the array drops. The drop represents the minimum. Time: O(log n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function findMin(nums) {
  let left = 0, right = nums.length - 1;
  ...
  return nums[left];
}`})]}),(0,b.jsx)(`h3`,{children:`Koko Eating Bananas`}),(0,b.jsx)(`p`,{children:`Determine the minimum eating speed (k) for Koko to eat all bananas within h hours.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Linear Search for k)`}),(0,b.jsx)(`p`,{children:`Try every speed starting from 1 up to the max pile size. Time: O(max(piles) * n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function minEatingSpeed(piles, h) {
...
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Binary Search on Answer)`}),(0,b.jsx)(`p`,{children:`Binary search the eating speed between 1 and max pile size. Time: O(n * log(max(piles))), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function minEatingSpeed(piles, h) {
  let left = 1;
  ...
  return left;
}`})]}),(0,b.jsx)(`h3`,{children:`Median of Two Sorted Arrays`}),(0,b.jsx)(`p`,{children:`Given two sorted arrays nums1 and nums2 of size m and n respectively, return the median of the two sorted arrays.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Merge and Sort/Find)`}),(0,b.jsx)(`p`,{children:`Merge both arrays into one sorted array, then find the median. Time: O(n + m), Space: O(n + m)`}),(0,b.jsx)(w,{language:`javascript`,children:`function findMedianSortedArrays(nums1, nums2) {
  ...
  return merged[mid];
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Binary Search on Partitions)`}),(0,b.jsx)(`p`,{children:`Binary search to find a partition in both arrays such that left half elements are less than or equal to right half elements. Time: O(log(min(m, n))), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function findMedianSortedArrays(nums1, nums2) {
...
}`})]})]}),be=()=>(0,b.jsxs)(C,{id:`dsa-linked-list`,title:`10.6 — Linked List`,icon:`🔗`,children:[(0,b.jsxs)(`h3`,{children:[`Reverse Linked List `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Given the head of a singly linked list, reverse the list, and return the reversed list.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Store in Array)`}),(0,b.jsx)(`p`,{children:`Traverse the linked list and store values in an array, then build a new reversed linked list. Time: O(n), Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function reverseList(head) {
  const vals = [];
  let curr = head;
  while (curr) {
    vals.push(curr.val);
  ...
  return newHead;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Iterative Pointers)`}),(0,b.jsx)(`p`,{children:`Use previous and current pointers to reverse the next links in-place. Time: O(n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function reverseList(head) {
  let prev = null;
  let curr = head;
  ...
  return prev;
}`})]}),(0,b.jsxs)(`h3`,{children:[`Merge Two Sorted Lists `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Merge two sorted linked lists into one sorted linked list.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Collect and Sort)`}),(0,b.jsx)(`p`,{children:`Collect all values from both lists into an array, sort the array, and reconstruct the list. Time: O(n log n), Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function mergeTwoLists(l1, l2) {
  const vals = [];
  ...
  return dummy.next;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Two Pointers)`}),(0,b.jsx)(`p`,{children:`Iterate through both lists simultaneously and link the smaller node to the merged list. Time: O(n + m), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function mergeTwoLists(l1, l2) {
  ...
  return dummy.next;
}`})]}),(0,b.jsxs)(`h3`,{children:[`Linked List Cycle `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Determine if a linked list has a cycle in it.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Hash Set)`}),(0,b.jsx)(`p`,{children:`Use a Set to keep track of nodes we've seen. If we encounter a seen node again, there is a cycle. Time: O(n), Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`function hasCycle(head) {
  const seen = new Set();
  let curr = head;
  ...
  return false;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Floyd's Tortoise and Hare)`}),(0,b.jsx)(`p`,{children:`Use a slow pointer and a fast pointer. If there is a cycle, the fast pointer will eventually catch up to the slow pointer. Time: O(n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function hasCycle(head) {
  let slow = head;
  let fast = head;
  ...
  return false;
}`})]}),(0,b.jsx)(`h3`,{children:`Remove Nth Node From End`}),(0,b.jsx)(`p`,{children:`Remove the nth node from the end of a linked list and return its head.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Two Passes)`}),(0,b.jsx)(`p`,{children:`First pass to count total length. Second pass to go to length - n node and remove it. Time: O(n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function removeNthFromEnd(head, n) {
  let length = 0;
  let curr = head;
  while (curr) {
    length++;
  ...
  return head;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (One Pass with Two Pointers)`}),(0,b.jsx)(`p`,{children:`Use two pointers. Move the fast pointer n steps ahead, then move both at the same speed. Time: O(n), Space: O(1)`}),(0,b.jsx)(w,{language:`javascript`,children:`function removeNthFromEnd(head, n) {
  ...
  return dummy.next;
}`})]}),(0,b.jsx)(`h3`,{children:`LRU Cache`}),(0,b.jsx)(`p`,{children:`Design a data structure that follows the constraints of a Least Recently Used (LRU) cache.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Array of Objects)`}),(0,b.jsx)(`p`,{children:`Keep an array or map tracking usage history and loop through to find the least recently used on evict. Time: O(n) for get/put, Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`class LRUCache {
...
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Doubly Linked List + Hash Map)`}),(0,b.jsx)(`p`,{children:`Map gives O(1) lookup to nodes. Doubly linked list allows O(1) addition/removal of nodes to manage LRU status. Time: O(1) for get/put, Space: O(n)`}),(0,b.jsx)(w,{language:`javascript`,children:`class Node {
  constructor(key, val) {
    this.key = key;
    this.val = val;
    this.prev = null;
...
class LRUCache {
...
}`})]})]}),xe=()=>(0,b.jsxs)(C,{id:`dsa-trees`,title:`10.7 — Trees`,icon:`🌲`,children:[(0,b.jsx)(`p`,{children:`Trees are hierarchical data structures. The most common is the Binary Tree, where each node has at most two children. Tree traversal algorithms like DFS (Pre, In, Post) and BFS are foundational.`}),(0,b.jsxs)(`h3`,{children:[`Maximum Depth of Binary Tree `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Find the maximum depth (number of nodes along the longest path from root to leaf) of a binary tree.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Iterative BFS)`}),(0,b.jsx)(`p`,{children:`Traverse level by level using a queue, incrementing depth at each level. Time: O(N), Space: O(N) for the queue in the worst case (the widest level).`}),(0,b.jsx)(w,{language:`javascript`,children:`function maxDepth(root) {
  if (!root) return 0;
  let queue = [root];
  let depth = 0;
  ...
  return depth;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Recursive DFS)`}),(0,b.jsx)(`p`,{children:`Use depth-first search recursively. The max depth of a tree is 1 + max(left_depth, right_depth). Time: O(N), Space: O(H) where H is tree height for the recursion stack.`}),(0,b.jsx)(w,{language:`javascript`,children:`function maxDepth(root) {
  if (!root) return 0;
  return 1 + Math.max(maxDepth(root.left), maxDepth(root.right));
}`})]}),(0,b.jsx)(`h3`,{children:`Invert Binary Tree`}),(0,b.jsx)(`p`,{children:`Invert a binary tree (flip it like a mirror). This is famously the question Max Howell was asked in an interview.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Iterative BFS)`}),(0,b.jsx)(`p`,{children:`Use a queue to process nodes level by level, swapping the left and right children. Time: O(N), Space: O(N) for the queue.`}),(0,b.jsx)(w,{language:`javascript`,children:`function invertTree(root) {
  if (!root) return null;
  let queue = [root];
  while (queue.length) {
    let node = queue.shift();
  ...
  return root;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Recursive DFS)`}),(0,b.jsx)(`p`,{children:`Recursively swap left and right subtrees. Time: O(N), Space: O(H) for the call stack.`}),(0,b.jsx)(w,{language:`javascript`,children:`function invertTree(root) {
  if (!root) return null;
  let temp = root.left;
  ...
  return root;
}`})]}),(0,b.jsx)(`h3`,{children:`Same Tree`}),(0,b.jsx)(`p`,{children:`Check if two binary trees are structurally identical and have the same node values.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Iterative BFS)`}),(0,b.jsx)(`p`,{children:`Use a queue to traverse both trees together and compare nodes. Time: O(N), Space: O(N).`}),(0,b.jsx)(w,{language:`javascript`,children:`function isSameTree(p, q) {
  let queue = [[p, q]];
  while (queue.length) {
  ...
  return true;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Recursive DFS)`}),(0,b.jsx)(`p`,{children:`Recursively check if current nodes are equal and their subtrees are equal. Time: O(N), Space: O(H).`}),(0,b.jsx)(w,{language:`javascript`,children:`function isSameTree(p, q) {
  if (!p && !q) return true;
  if (!p || !q || p.val !== q.val) return false;
  return isSameTree(p.left, q.left) && isSameTree(p.right, q.right);
}`})]}),(0,b.jsxs)(`h3`,{children:[`Binary Tree Level Order Traversal `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Return the level order traversal of its nodes' values. (i.e., from left to right, level by level).`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Recursive DFS)`}),(0,b.jsx)(`p`,{children:`Pass the depth down the recursive calls to place node values into the correct array index. Time: O(N), Space: O(N) for output arrays + recursion stack.`}),(0,b.jsx)(w,{language:`javascript`,children:`function levelOrder(root) {
  let res = [];
  ...
  dfs(root, 0);
  return res;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Iterative BFS)`}),(0,b.jsx)(`p`,{children:`Use a queue. Process level by level naturally. Time: O(N), Space: O(N) for queue and result arrays.`}),(0,b.jsx)(w,{language:`javascript`,children:`function levelOrder(root) {
  if (!root) return [];
  let res = [];
  let queue = [root];
  ...
  return res;
}`})]}),(0,b.jsx)(`h3`,{children:`Lowest Common Ancestor`}),(0,b.jsx)(`p`,{children:`Find the lowest common ancestor (LCA) of two given nodes in a Binary Search Tree.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Recursive Search)`}),(0,b.jsx)(`p`,{children:`If both values are lesser, search left. If both are greater, search right. Otherwise, we found the split point. Time: O(H), Space: O(H).`}),(0,b.jsx)(w,{language:`javascript`,children:`function lowestCommonAncestor(root, p, q) {
...
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Iterative)`}),(0,b.jsx)(`p`,{children:`Same logic, but iterate down the tree avoiding call stack overhead. Time: O(H), Space: O(1).`}),(0,b.jsx)(w,{language:`javascript`,children:`function lowestCommonAncestor(root, p, q) {
  let curr = root;
  while (curr) {
...
}`})]}),(0,b.jsxs)(`h3`,{children:[`Validate BST `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Determine if a binary tree is a valid binary search tree (BST).`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Inorder Array)`}),(0,b.jsx)(`p`,{children:`Do an inorder traversal, collect values, and check if array is strictly increasing. Time: O(N), Space: O(N).`}),(0,b.jsx)(w,{language:`javascript`,children:`function isValidBST(root) {
  let values = [];
  ...
  return true;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Recursive with Boundaries)`}),(0,b.jsx)(`p`,{children:`Pass down a valid range [min, max] for each node to ensure every node satisfies the BST condition constraint. Time: O(N), Space: O(H).`}),(0,b.jsx)(w,{language:`javascript`,children:`function isValidBST(root, min = null, max = null) {
  if (!root) return true;
  if ((min !== null && root.val <= min) || (max !== null && root.val >= max)) {
    return false;
  }
  return isValidBST(root.left, min, root.val) && isValidBST(root.right, root.val, max);
}`})]}),(0,b.jsx)(`h3`,{children:`Kth Smallest Element in BST`}),(0,b.jsx)(`p`,{children:`Given the root of a BST, find the kth smallest value (1-indexed).`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Recursive Inorder Array)`}),(0,b.jsx)(`p`,{children:`Flatten the tree to an array via inorder traversal, then pick the (k-1)th element. Time: O(N), Space: O(N).`}),(0,b.jsx)(w,{language:`javascript`,children:`function kthSmallest(root, k) {
  let values = [];
  function inorder(node) {
    if (!node) return;
    inorder(node.left);
  ...
  inorder(root);
  return values[k - 1];
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Iterative Inorder Traversal)`}),(0,b.jsx)(`p`,{children:`Use a stack to simulate inorder traversal and stop early when we hit the k-th node. Time: O(H + k), Space: O(H) for the stack.`}),(0,b.jsx)(w,{language:`javascript`,children:`function kthSmallest(root, k) {
  let stack = [];
  let curr = root;
  let count = 0;
...
}`})]})]}),Se=()=>(0,b.jsxs)(C,{id:`dsa-graphs`,title:`10.8 — Graphs`,icon:`🕸️`,children:[(0,b.jsx)(`p`,{children:`Graph problems involve nodes (vertices) and connections (edges). Identifying whether to use BFS, DFS, or Topological Sort is key.`}),(0,b.jsxs)(`h3`,{children:[`Number of Islands `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Given a 2D grid map of '1's (land) and '0's (water), count the number of islands. An island is surrounded by water and formed by connecting adjacent lands horizontally or vertically.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (BFS)`}),(0,b.jsx)(`p`,{children:`Iterate through grid. When a '1' is found, increment count and run BFS to mark all connected '1's as visited (or flip to '0'). Time: O(M * N), Space: O(min(M, N)) for queue.`}),(0,b.jsx)(w,{language:`javascript`,children:`function numIslands(grid) {
  let count = 0;
  ...
  return count;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (DFS)`}),(0,b.jsx)(`p`,{children:`Similar logic but recursive DFS. Usually cleaner to implement. Time: O(M * N), Space: O(M * N) worst case for recursion stack.`}),(0,b.jsx)(w,{language:`javascript`,children:`function numIslands(grid) {
  let count = 0;
  ...
  return count;
}`})]}),(0,b.jsx)(`h3`,{children:`Clone Graph`}),(0,b.jsx)(`p`,{children:`Return a deep copy (clone) of a graph where each node contains a value and a list of neighbors.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (BFS)`}),(0,b.jsx)(`p`,{children:`Use a queue and a hash map to map original nodes to their clones. Time: O(V + E), Space: O(V).`}),(0,b.jsx)(w,{language:`javascript`,children:`function cloneGraph(node) {
  if (!node) return null;
  let map = new Map();
  let queue = [node];
  ...
  return map.get(node);
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (DFS)`}),(0,b.jsx)(`p`,{children:`Recursive DFS using a map to keep track of already visited nodes to prevent cycles. Time: O(V + E), Space: O(V).`}),(0,b.jsx)(w,{language:`javascript`,children:`function cloneGraph(node) {
  let map = new Map();
  function dfs(node) {
    if (!node) return null;
  ...
  return dfs(node);
}`})]}),(0,b.jsxs)(`h3`,{children:[`Course Schedule `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Given total courses and prerequisites, determine if it is possible to finish all courses (detect cycles in a directed graph).`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (DFS Cycle Detection)`}),(0,b.jsx)(`p`,{children:`Track visiting state for nodes. If we hit a node currently in the path, there's a cycle. Time: O(V + E), Space: O(V + E).`}),(0,b.jsx)(w,{language:`javascript`,children:`function canFinish(numCourses, prerequisites) {
  ...
  return true;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Kahn's Algorithm - BFS)`}),(0,b.jsx)(`p`,{children:`Use in-degrees. Nodes with in-degree 0 can be completed. Decrement neighbors and add to queue. Time: O(V + E), Space: O(V + E).`}),(0,b.jsx)(w,{language:`javascript`,children:`function canFinish(numCourses, prerequisites) {
...
}`})]}),(0,b.jsx)(`h3`,{children:`Pacific Atlantic Water Flow`}),(0,b.jsx)(`p`,{children:`Given an m x n matrix of heights, find all coordinates that can flow to BOTH the Pacific (top/left) and Atlantic (bottom/right) oceans.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (DFS from each cell)`}),(0,b.jsx)(`p`,{children:`Run a DFS from every single cell and check if it reaches both oceans. This repeats a lot of work. Time: O((M*N)^2), Space: O(M*N).`}),(0,b.jsx)(w,{language:`javascript`,children:`// Pseudocode:
// For each cell [r, c]:
//   visited = set()
//   if dfs(r, c) reaches Pacific AND dfs(r, c) reaches Atlantic:
//     add [r, c] to result
// Very slow, will Time Out on large grids.`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (DFS from Oceans)`}),(0,b.jsx)(`p`,{children:`Start from ocean borders and flow water "uphill" to the inner cells. Intersect the results. Time: O(M*N), Space: O(M*N).`}),(0,b.jsx)(w,{language:`javascript`,children:`function pacificAtlantic(heights) {
  ...
  return res;
}`})]}),(0,b.jsx)(`h3`,{children:`Word Ladder`}),(0,b.jsx)(`p`,{children:`Transform a beginWord to an endWord changing one letter at a time, where every transformed word must be in a wordList. Return shortest sequence length.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (DFS Backtracking)`}),(0,b.jsx)(`p`,{children:`Explore all possible paths recursively to find the minimum length. Extremely slow, easily leads to TLE. Time: Exponential, Space: O(N) call stack.`}),(0,b.jsx)(w,{language:`javascript`,children:`// Pseudocode:
...
// Will Time Out.`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (BFS)`}),(0,b.jsx)(`p`,{children:`Shortest path in an unweighted graph is best solved with BFS. Time: O(M^2 * N) where M is word length and N is word list size. Space: O(M * N).`}),(0,b.jsx)(w,{language:`javascript`,children:`function ladderLength(beginWord, endWord, wordList) {
  ...
  return 0;
}`})]})]}),Ce=()=>(0,b.jsxs)(C,{id:`dsa-dp`,title:`10.9 — Dynamic Programming`,icon:`🧠`,children:[(0,b.jsx)(`p`,{children:`Dynamic Programming (DP) is about breaking problems into subproblems and saving overlapping subproblem results (memoization/tabulation).`}),(0,b.jsx)(`h3`,{children:`Climbing Stairs`}),(0,b.jsx)(`p`,{children:`You are climbing a staircase. It takes n steps to reach the top. Each time you can either climb 1 or 2 steps. How many distinct ways can you climb?`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Recursive)`}),(0,b.jsx)(`p`,{children:`Recurse tree taking 1 and 2 steps. This evaluates overlapping subproblems repeatedly. Time: O(2^n), Space: O(n) call stack.`}),(0,b.jsx)(w,{language:`javascript`,children:`function climbStairs(n) {
  if (n <= 2) return n;
  return climbStairs(n - 1) + climbStairs(n - 2);
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Iterative DP / Fibonacci)`}),(0,b.jsx)(`p`,{children:`Use two variables to track previous step combinations instead of an array. Time: O(n), Space: O(1).`}),(0,b.jsx)(w,{language:`javascript`,children:`function climbStairs(n) {
  if (n <= 2) return n;
  let prev2 = 1, prev1 = 2;
  ...
  return prev1;
}`})]}),(0,b.jsxs)(`h3`,{children:[`House Robber `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Given an array of integers representing house money, determine the max money you can rob without robbing adjacent houses.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Recursive with Memoization)`}),(0,b.jsx)(`p`,{children:`Top-down DP. Choice is either to rob current house + jump two, or skip current. Time: O(n), Space: O(n).`}),(0,b.jsx)(w,{language:`javascript`,children:`function rob(nums) {
  let memo = {};
  function dp(i) {
  ...
  return dp(0);
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Iterative Bottom-Up O(1) Space)`}),(0,b.jsx)(`p`,{children:`Keep track of the max money at the last two steps. Time: O(n), Space: O(1).`}),(0,b.jsx)(w,{language:`javascript`,children:`function rob(nums) {
  let rob1 = 0, rob2 = 0;
  ...
  return rob2;
}`})]}),(0,b.jsxs)(`h3`,{children:[`Coin Change `,(0,b.jsx)(k,{variant:`purple`,children:`Frontend Priority`})]}),(0,b.jsx)(`p`,{children:`Given an array of coins and a target amount, return the fewest number of coins that make up that amount.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (DFS with Memoization)`}),(0,b.jsx)(`p`,{children:`Try every coin repeatedly. Top-down DP. Time: O(amount * len(coins)), Space: O(amount) recursion stack.`}),(0,b.jsx)(w,{language:`javascript`,children:`function coinChange(coins, amount) {
  let memo = {};
  function dfs(rem) {
    if (rem === 0) return 0;
    if (rem < 0) return -1;
  ...
  return dfs(amount);
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Bottom-Up Tabulation)`}),(0,b.jsx)(`p`,{children:`Build an array from 0 to amount. For each amount, check each coin. Time: O(amount * len(coins)), Space: O(amount).`}),(0,b.jsx)(w,{language:`javascript`,children:`function coinChange(coins, amount) {
...
}`})]}),(0,b.jsx)(`h3`,{children:`Longest Increasing Subsequence`}),(0,b.jsx)(`p`,{children:`Given an integer array, return the length of the longest strictly increasing subsequence.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Dynamic Programming)`}),(0,b.jsx)(`p`,{children:`Compare each element with every element before it. Time: O(n^2), Space: O(n).`}),(0,b.jsx)(w,{language:`javascript`,children:`function lengthOfLIS(nums) {
  ...
  return max;
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Binary Search)`}),(0,b.jsx)(`p`,{children:`Maintain a list of smallest tails for increasing subsequences. Overwrite with binary search. Time: O(n log n), Space: O(n).`}),(0,b.jsx)(w,{language:`javascript`,children:`function lengthOfLIS(nums) {
  let tails = [];
  ...
  return tails.length;
}`})]}),(0,b.jsx)(`h3`,{children:`Longest Common Subsequence`}),(0,b.jsx)(`p`,{children:`Given two strings, return the length of their longest common subsequence.`}),(0,b.jsxs)(T,{type:`warning`,children:[(0,b.jsx)(`h4`,{children:`Normal Approach (Recursive with Memoization)`}),(0,b.jsx)(`p`,{children:`Check characters from the end. If match, 1 + move both. Else max of moving one or the other. Time: O(m*n), Space: O(m*n).`}),(0,b.jsx)(w,{language:`javascript`,children:`function longestCommonSubsequence(text1, text2) {
  let memo = {};
  function dfs(i, j) {
  ...
  return dfs(0, 0);
}`})]}),(0,b.jsxs)(T,{type:`success`,children:[(0,b.jsx)(`h4`,{children:`Optimal Approach (Bottom-Up 2D Array)`}),(0,b.jsx)(`p`,{children:`Use a 2D matrix. Fill from bottom-right to top-left. Time: O(m*n), Space: O(m*n).`}),(0,b.jsx)(w,{language:`javascript`,children:`function longestCommonSubsequence(text1, text2) {
  ...
  return dp[0][0];
}`})]})]});function we(){return(0,b.jsxs)(ie,{id:`important-dsa`,number:`10`,title:`Important DSA in JavaScript`,theme:`purple`,children:[(0,b.jsxs)(`p`,{className:`section-intro`,children:[`Data Structures and Algorithms (DSA) are the foundation of computer science and technical interviews. In this chapter, we cover the top 45+ medium-to-hard level problems across 9 key patterns. Each problem includes the brute-force ("Normal") approach and the optimized ("Optimal") approach. Look out for the `,(0,b.jsx)(`strong`,{children:`Frontend Priority`}),` badges which highlight the 20 most crucial problems to study if you are short on time.`]}),(0,b.jsx)(he,{}),(0,b.jsx)(ge,{}),(0,b.jsx)(_e,{}),(0,b.jsx)(ve,{}),(0,b.jsx)(ye,{}),(0,b.jsx)(be,{}),(0,b.jsx)(xe,{}),(0,b.jsx)(Se,{}),(0,b.jsx)(Ce,{})]})}function Te(){return(0,b.jsxs)(te,{children:[(0,b.jsx)(S,{}),(0,b.jsx)(ne,{chapters:ee}),(0,b.jsx)(se,{}),(0,b.jsx)(ce,{}),(0,b.jsx)(le,{}),(0,b.jsx)(ue,{}),(0,b.jsx)(de,{}),(0,b.jsx)(fe,{}),(0,b.jsx)(A,{}),(0,b.jsx)(pe,{}),(0,b.jsx)(me,{}),(0,b.jsx)(we,{}),(0,b.jsx)(re,{})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,b.jsx)(_.StrictMode,{children:(0,b.jsx)(Te,{})}));