...
<span class="kw">public class</span> <span class="fn">EmailConfiguration</span> {
  ...
  profiles:
    active: dev`}),(0,k.jsx)(N,{type:`tip`,title:`Advanced Conditionals`,children:"Spring Boot auto-configuration relies heavily on the `@Conditional` family of annotations. You can use these in your own code to dynamically register beans. Examples include: `@ConditionalOnProperty`, `@ConditionalOnClass`, and `@ConditionalOnMissingBean`."})]})]}),Qr=()=>(0,k.jsxs)(A,{id:`sb-chapter-3`,number:3,title:`Building REST APIs with Spring MVC`,theme:`green`,children:[(0,k.jsx)(`p`,{children:"Spring MVC is the web framework built into Spring Boot. It uses the `DispatcherServlet` to route incoming HTTP requests to the appropriate handlers (Controllers). When building REST APIs, Spring MVC handles the heavy lifting of routing, parameter extraction, and serialization."}),(0,k.jsxs)(j,{id:`rest-controller`,icon:`🌐`,iconBg:`#e6f4ea`,iconColor:`#137333`,title:`3.1 @RestController & Request Mapping`,children:[(0,k.jsx)(`p`,{children:"The `@RestController` annotation is a specialized version of `@Controller`. It combines `@Controller` and `@ResponseBody`, meaning every method returns a domain object instead of a view (HTML page), and Spring automatically serializes it into the HTTP response body (usually as JSON)."}),(0,k.jsx)(M,{filename:`ProductController.java`,language:`java`,children:`<span class="attr">@RestController</span>
...
}`}),(0,k.jsx)(`p`,{children:"The core Terraform workflow consists of three commands: `terraform init` (downloads plugins), `terraform plan` (shows what will change), and `terraform apply` (executes the changes)."})]}),(0,k.jsxs)(j,{id:`state-management`,icon:`💾`,iconBg:`#fef3c7`,iconColor:`#d97706`,title:`7.3 State Management`,children:[(0,k.jsx)(`p`,{children:"Terraform must map the resources in your configuration files to the actual resources in the real world (e.g., matching the `aws_instance` block to the actual EC2 instance ID `i-0abcdef1234567890`)."}),(0,k.jsxs)(`p`,{children:[`It does this using a `,(0,k.jsx)(`strong`,{children:`State File`})," (`terraform.tfstate`). In a team environment, this file must never be committed to Git (it contains cleartext secrets and leads to merge conflicts). Instead, it must be stored in a remote backend (like an AWS S3 bucket) with state locking enabled (via DynamoDB) to prevent concurrent executions from corrupting the infrastructure."]})]})]})}function vi(){return(0,k.jsxs)(A,{id:`cloud-providers`,number:8,title:`Cloud Providers (AWS Overview)`,theme:`amber`,children:[(0,k.jsx)(`p`,{children:`The cloud is simply someone else's computer, but it provides on-demand availability of computer system resources, especially data storage and computing power, without direct active management by the user. Amazon Web Services (AWS) is the dominant market leader.`}),(0,k.jsxs)(j,{id:`cloud-computing`,icon:`☁️`,iconBg:`#fef3c7`,iconColor:`#d97706`,title:`8.1 Cloud Computing Models`,children:[(0,k.jsx)(`p`,{children:`Cloud services are generally divided into three main categories:`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`IaaS (Infrastructure as a Service):`}),` You rent the raw servers, networking, and storage. You are responsible for the OS and everything above it. (e.g., AWS EC2).`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`PaaS (Platform as a Service):`}),` The cloud provider manages the OS and runtime. You just upload your application code. (e.g., Heroku, AWS Elastic Beanstalk).`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`SaaS (Software as a Service):`}),` Fully managed applications consumed via the browser. (e.g., Gmail, Salesforce).`]})]})]}),(0,k.jsxs)(j,{id:`aws-core`,icon:`🔶`,iconBg:`#fef3c7`,iconColor:`#d97706`,title:`8.2 Core AWS Services`,children:[(0,k.jsx)(`p`,{children:`AWS has hundreds of services, but almost all architectures rely on these core primitives:`}),(0,k.jsxs)(`table`,{className:`devops-table`,children:[(0,k.jsx)(`thead`,{children:(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`th`,{children:`Service Name`}),(0,k.jsx)(`th`,{children:`Category`}),(0,k.jsx)(`th`,{children:`Description`})]})}),(0,k.jsxs)(`tbody`,{children:[(0,k.jsxs)(`tr`,{children:[(0,k.jsxs)(`td`,{children:[(0,k.jsx)(`strong`,{children:`EC2`}),` (Elastic Compute Cloud)`]}),(0,k.jsx)(`td`,{children:`Compute`}),(0,k.jsx)(`td`,{children:`Virtual machines in the cloud. You have full root access.`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsxs)(`td`,{children:[(0,k.jsx)(`strong`,{children:`S3`}),` (Simple Storage Service)`]}),(0,k.jsx)(`td`,{children:`Storage`}),(0,k.jsx)(`td`,{children:`Object storage for files, images, backups, and static websites.`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsxs)(`td`,{children:[(0,k.jsx)(`strong`,{children:`RDS`}),` (Relational Database Service)`]}),(0,k.jsx)(`td`,{children:`Database`}),(0,k.jsx)(`td`,{children:`Managed SQL databases (PostgreSQL, MySQL). AWS handles backups and patching.`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsxs)(`td`,{children:[(0,k.jsx)(`strong`,{children:`VPC`}),` (Virtual Private Cloud)`]}),(0,k.jsx)(`td`,{children:`Networking`}),(0,k.jsx)(`td`,{children:`Your private, isolated section of the AWS network where you launch resources.`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsxs)(`td`,{children:[(0,k.jsx)(`strong`,{children:`IAM`}),` (Identity and Access Management)`]}),(0,k.jsx)(`td`,{children:`Security`}),(0,k.jsx)(`td`,{children:`Manages users, roles, and permissions across AWS.`})]})]})]})]}),(0,k.jsxs)(j,{id:`serverless`,icon:`⚡`,iconBg:`#fef3c7`,iconColor:`#d97706`,title:`8.3 Serverless Computing (Lambda)`,children:[(0,k.jsx)(`p`,{children:`"Serverless" doesn't mean there are no servers; it means you don't manage them, and you only pay for the exact milliseconds your code is executing.`}),(0,k.jsxs)(`p`,{children:[(0,k.jsx)(`strong`,{children:`AWS Lambda`}),` allows you to run code in response to events (like an HTTP request via API Gateway, or a file being uploaded to S3). It automatically scales from zero to thousands of concurrent executions instantly, making it highly cost-effective for spiky workloads.`]})]})]})}function yi(){return(0,k.jsxs)(A,{id:`observability`,number:9,title:`Monitoring & Observability`,theme:`amber`,children:[(0,k.jsx)(`p`,{children:`You cannot manage what you cannot measure. Once an application is deployed, you must know if it's healthy, if it's fast, and exactly why it crashed at 3:00 AM. This is the domain of Observability.`}),(0,k.jsxs)(j,{id:`metrics-logs-traces`,icon:`📊`,iconBg:`#fef3c7`,iconColor:`#d97706`,title:`9.1 The Three Pillars of Observability`,children:[(0,k.jsx)(`p`,{children:`True observability is built on three distinct types of telemetry data:`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Metrics:`}),` Aggregated numeric data over time (e.g., CPU usage is 85%, API error rate is 2%). Great for triggering alerts.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Logs:`}),` Discrete text records of events that happened (e.g., "User 123 logged in", "NullPointerException at line 42"). Essential for debugging.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Traces:`}),` Represent the lifecycle of a single request as it travels across multiple microservices. Crucial for identifying latency bottlenecks in distributed systems.`]})]})]}),(0,k.jsxs)(j,{id:`prometheus-grafana`,icon:`📈`,iconBg:`#fef3c7`,iconColor:`#d97706`,title:`9.2 Prometheus & Grafana (Metrics)`,children:[(0,k.jsxs)(`p`,{children:[(0,k.jsx)(`strong`,{children:`Prometheus`}),` is an open-source systems monitoring and alerting toolkit. Unlike legacy systems that wait for servers to push data to them, Prometheus uses a `,(0,k.jsx)(`em`,{children:`pull model`}),". It periodically scrapes HTTP endpoints (like `/metrics`) exposed by your applications to collect time-series data."]}),(0,k.jsxs)(`p`,{children:[(0,k.jsx)(`strong`,{children:`Grafana`}),` is the visualization layer. It connects to Prometheus (and many other data sources) to create beautiful, dynamic dashboards that visualize your metrics.`]})]}),(0,k.jsxs)(j,{id:`elk-stack`,icon:`🔍`,iconBg:`#fef3c7`,iconColor:`#d97706`,title:`9.3 The ELK Stack (Logs)`,children:[(0,k.jsx)(`p`,{children:"When you have 50 microservices running across 200 Kubernetes pods, SSHing into a server to read a log file using `grep` is impossible. You need centralized logging."}),(0,k.jsxs)(`p`,{children:[`The `,(0,k.jsx)(`strong`,{children:`ELK Stack`}),` is the most popular solution:`]}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Elasticsearch:`}),` A highly scalable, full-text search and analytics engine where all logs are stored and indexed.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Logstash`}),` (or Fluentd/Filebeat): The data collection pipeline that ingests logs from your containers, transforms them (e.g., parsing JSON), and sends them to Elasticsearch.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Kibana:`}),` The visualization dashboard that allows you to search, filter, and analyze the logs stored in Elasticsearch.`]})]})]})]})}function bi(){return(0,k.jsxs)(gr,{chapters:nr,brand:{title:`DevOps`,logo:`♾️`,gradient:`linear-gradient(90deg, #f59e0b, #d97706)`,themeColor:`amber`},children:[(0,k.jsx)(xr,{chapters:nr,config:{title:`DevOps & Infrastructure Guide`,subtitle:`From code to cloud`,description:`Master the art of shipping software reliably. Learn Linux, Docker, Kubernetes, CI/CD pipelines, and Infrastructure as Code to build resilient platforms.`,meta:[`Containers`,`Kubernetes`,`CI/CD`,`Cloud`],theme:`amber`}}),(0,k.jsx)(di,{}),(0,k.jsx)(fi,{}),(0,k.jsx)(pi,{}),(0,k.jsx)(mi,{}),(0,k.jsx)(hi,{}),(0,k.jsx)(gi,{}),(0,k.jsx)(_i,{}),(0,k.jsx)(vi,{}),(0,k.jsx)(yi,{})]})}function xi(){return(0,k.jsxs)(A,{id:`sd-chapter-1`,number:`1`,title:`Introduction to System Design`,theme:`purple`,children:[(0,k.jsxs)(j,{id:`sd-intro-basics`,title:`1.1 What is System Design?`,children:[(0,k.jsx)(`p`,{children:`System design is the process of defining the architecture, modules, interfaces, and data for a system to satisfy specified requirements. It involves understanding how different components communicate with each other, how data flows through the system, and what the trade-offs are for various architectural decisions.`}),(0,k.jsxs)(`div`,{className:`callout callout-info`,children:[(0,k.jsx)(`strong`,{children:`Key Concept:`}),` Modern system design heavily focuses on distributed systems because a single machine cannot handle the scale of today's internet applications.`]})]}),(0,k.jsxs)(j,{id:`sd-intro-scaling`,title:`1.2 Vertical vs Horizontal Scaling`,children:[(0,k.jsx)(`p`,{children:`When your system reaches its limits, you need to scale it. There are two primary ways to do this:`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Vertical Scaling (Scale Up):`}),` Adding more power (CPU, RAM, Storage) to your existing machine.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Horizontal Scaling (Scale Out):`}),` Adding more machines to your pool of resources.`]})]}),(0,k.jsx)(`p`,{children:`While vertical scaling is easier to implement initially, it has a hard limit. Horizontal scaling is the standard for large-scale distributed systems, though it introduces complexity like data consistency and load balancing.`})]}),(0,k.jsxs)(j,{id:`sd-intro-tradeoffs`,title:`1.3 Trade-offs (CAP Theorem)`,children:[(0,k.jsx)(`p`,{children:`In a distributed system, you are forced to make trade-offs. The CAP theorem states that a distributed data store can only simultaneously provide two of the following three guarantees:`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Consistency:`}),` Every read receives the most recent write or an error.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Availability:`}),` Every request receives a (non-error) response, without the guarantee that it contains the most recent write.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Partition Tolerance:`}),` The system continues to operate despite an arbitrary number of messages being dropped (or delayed) by the network between nodes.`]})]}),(0,k.jsx)(`p`,{children:`Since network partitions are inevitable in distributed systems, we generally have to choose between Consistency and Availability.`})]})]})}function Si(){return(0,k.jsxs)(A,{id:`sd-chapter-2`,number:`2`,title:`Data & Databases`,theme:`purple`,children:[(0,k.jsxs)(j,{id:`sd-db-sql-nosql`,title:`2.1 SQL vs NoSQL`,children:[(0,k.jsx)(`p`,{children:`Choosing between SQL (Relational) and NoSQL (Non-Relational) is a fundamental decision in system design.`}),(0,k.jsx)(`div`,{className:`table-responsive`,children:(0,k.jsxs)(`table`,{children:[(0,k.jsx)(`thead`,{children:(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`th`,{children:`Feature`}),(0,k.jsx)(`th`,{children:`SQL Databases`}),(0,k.jsx)(`th`,{children:`NoSQL Databases`})]})}),(0,k.jsxs)(`tbody`,{children:[(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`strong`,{children:`Schema`})}),(0,k.jsx)(`td`,{children:`Fixed/Rigid schemas`}),(0,k.jsx)(`td`,{children:`Dynamic/Flexible schemas`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`strong`,{children:`Scaling`})}),(0,k.jsx)(`td`,{children:`Primarily Vertical Scaling`}),(0,k.jsx)(`td`,{children:`Primarily Horizontal Scaling`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`strong`,{children:`Data Structure`})}),(0,k.jsx)(`td`,{children:`Tables, Rows, Columns`}),(0,k.jsx)(`td`,{children:`Key-Value, Document, Graph, Wide-Column`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`strong`,{children:`ACID Properties`})}),(0,k.jsx)(`td`,{children:`Strong ACID compliance`}),(0,k.jsx)(`td`,{children:`Often BASE (Eventually Consistent)`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`strong`,{children:`Best For`})}),(0,k.jsx)(`td`,{children:`Complex queries, transactions (Banking)`}),(0,k.jsx)(`td`,{children:`Rapid development, unstructured data, high volume`})]})]})]})})]}),(0,k.jsxs)(j,{id:`sd-db-sharding`,title:`2.2 Database Sharding & Replication`,children:[(0,k.jsx)(`h3`,{children:`Replication`}),(0,k.jsx)(`p`,{children:`Replication involves keeping a copy of the same data on multiple machines. It increases availability and read throughput. Common strategies include Master-Slave (writes to master, reads from slaves) and Master-Master (writes to any node).`}),(0,k.jsx)(`h3`,{children:`Sharding (Data Partitioning)`}),(0,k.jsx)(`p`,{children:`Sharding is the process of splitting a single logical database into multiple physical databases (shards) across different servers. It allows horizontal scaling of the database.`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Range Based Sharding:`}),` Data is split based on a range of values (e.g., Users A-M on Shard 1, N-Z on Shard 2). Can lead to hotspots.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Hash Based Sharding:`}),` A hash function determines the shard. Evens out data distribution but makes range queries difficult.`]})]}),(0,k.jsxs)(`div`,{className:`callout callout-warning`,children:[(0,k.jsx)(`strong`,{children:`Warning:`}),` Sharding adds immense complexity to your application (joins across shards, distributed transactions). Only use when vertical scaling and replication are no longer sufficient.`]})]}),(0,k.jsxs)(j,{id:`sd-db-caching`,title:`2.3 Caching Strategies`,children:[(0,k.jsx)(`p`,{children:`Caching stores frequently accessed data in fast-access hardware (like RAM) to reduce latency and database load. Redis and Memcached are popular tools.`}),(0,k.jsx)(`h4`,{children:`Common Eviction Policies:`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`LRU (Least Recently Used):`}),` Discards the least recently used items first.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`LFU (Least Frequently Used):`}),` Discards the least frequently used items first.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`FIFO (First In First Out):`}),` Discards the oldest items first.`]})]}),(0,k.jsx)(`h4`,{children:`Common Caching Patterns:`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Cache-Aside:`}),` Application checks cache; if miss, fetches from DB and updates cache.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Write-Through:`}),` Application writes to cache, which synchronously writes to DB. High write latency, high read consistency.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Write-Behind (Write-Back):`}),` Application writes to cache, which asynchronously writes to DB. Low write latency, risk of data loss.`]})]})]})]})}function Ci(){return(0,k.jsxs)(A,{id:`sd-chapter-3`,number:`3`,title:`Architecture Patterns`,theme:`purple`,children:[(0,k.jsxs)(j,{id:`sd-arch-microservices`,title:`3.1 Microservices Architecture`,children:[(0,k.jsx)(`p`,{children:`Microservices architecture structures an application as a collection of loosely coupled, independently deployable services. Each service is organized around a business capability.`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Pros:`}),` Independent deployment, fault isolation, technology diversity, easier horizontal scaling.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Cons:`}),` Distributed system complexity, network latency, data consistency (CAP theorem), complex debugging.`]})]}),(0,k.jsxs)(`p`,{children:[`It contrasts with a `,(0,k.jsx)(`strong`,{children:`Monolith`}),`, where all code is packaged in a single deployable unit. Monoliths are simpler to start with but harder to scale and maintain as the team and codebase grow.`]})]}),(0,k.jsxs)(j,{id:`sd-arch-event-driven`,title:`3.2 Event-Driven Architecture`,children:[(0,k.jsx)(`p`,{children:`Event-driven architecture (EDA) is a software design pattern where decoupled applications asynchronously publish and subscribe to events via an event broker (e.g., Kafka, RabbitMQ).`}),(0,k.jsxs)(`p`,{children:[`An `,(0,k.jsx)(`strong`,{children:`event`}),` is a change in state, like "User Registered" or "Item Added to Cart".`]}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Producer:`}),` Generates and publishes the event. Doesn't know who will consume it.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Consumer:`}),` Subscribes to events and reacts to them.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Broker:`}),` Mediates communication, ensuring events are reliably delivered.`]})]}),(0,k.jsxs)(`div`,{className:`callout callout-info`,children:[(0,k.jsx)(`strong`,{children:`Key Concept:`}),` EDA promotes high decoupling, allowing teams to develop and deploy services completely independently as long as they adhere to the event schema.`]})]}),(0,k.jsxs)(j,{id:`sd-arch-serverless`,title:`3.3 Serverless Functions`,children:[(0,k.jsx)(`p`,{children:`Serverless computing (e.g., AWS Lambda, Google Cloud Functions) allows you to build and run applications without managing servers. The cloud provider automatically provisions, scales, and manages the infrastructure required to run the code.`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Pros:`}),` No server management, auto-scaling (scale to zero), pay only for what you use, faster time to market.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Cons:`}),` Vendor lock-in, cold starts (delay when a function is invoked after being idle), complex monitoring, limited execution duration.`]})]}),(0,k.jsx)(`p`,{children:`Serverless is excellent for event-driven workflows, background processing, and unpredictable workloads.`})]})]})}function wi(){return(0,k.jsxs)(A,{id:`sd-chapter-4`,number:`4`,title:`Networking & APIs`,theme:`purple`,children:[(0,k.jsxs)(j,{id:`sd-net-rest-graphql`,title:`4.1 REST vs GraphQL vs gRPC`,children:[(0,k.jsx)(`p`,{children:`APIs allow different software systems to communicate. Choosing the right paradigm depends on your needs.`}),(0,k.jsx)(`div`,{className:`table-responsive`,children:(0,k.jsxs)(`table`,{children:[(0,k.jsx)(`thead`,{children:(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`th`,{children:`Feature`}),(0,k.jsx)(`th`,{children:`REST`}),(0,k.jsx)(`th`,{children:`GraphQL`}),(0,k.jsx)(`th`,{children:`gRPC`})]})}),(0,k.jsxs)(`tbody`,{children:[(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`strong`,{children:`Protocol`})}),(0,k.jsx)(`td`,{children:`HTTP 1.1`}),(0,k.jsx)(`td`,{children:`HTTP 1.1 (or 2)`}),(0,k.jsx)(`td`,{children:`HTTP/2`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`strong`,{children:`Data Format`})}),(0,k.jsx)(`td`,{children:`JSON (usually)`}),(0,k.jsx)(`td`,{children:`JSON`}),(0,k.jsx)(`td`,{children:`Protocol Buffers (Binary)`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`strong`,{children:`Over-fetching`})}),(0,k.jsx)(`td`,{children:`Common`}),(0,k.jsx)(`td`,{children:`Client specifies exactly what it needs`}),(0,k.jsx)(`td`,{children:`Defined by rigid schemas`})]}),(0,k.jsxs)(`tr`,{children:[(0,k.jsx)(`td`,{children:(0,k.jsx)(`strong`,{children:`Best For`})}),(0,k.jsx)(`td`,{children:`Public APIs, CRUD apps`}),(0,k.jsx)(`td`,{children:`Complex UI apps, mobile, aggregating multiple APIs`}),(0,k.jsx)(`td`,{children:`Internal Microservices, high performance`})]})]})]})})]}),(0,k.jsxs)(j,{id:`sd-net-load-balancing`,title:`4.2 Load Balancers & API Gateways`,children:[(0,k.jsx)(`h3`,{children:`Load Balancers`}),(0,k.jsx)(`p`,{children:`A Load Balancer distributes incoming network traffic across a group of backend servers (a server farm or server pool).`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`L4 Load Balancing (Transport):`}),` Routes traffic based on IP address and port. Fast but lacks application awareness.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`L7 Load Balancing (Application):`}),` Routes traffic based on HTTP headers, URLs, or cookies. Slower but allows smarter routing.`]})]}),(0,k.jsx)(`h3`,{children:`API Gateways`}),(0,k.jsx)(`p`,{children:`An API Gateway is a server that acts as an API front-end, receiving API requests, enforcing throttling and security policies, passing requests to the back-end service and then passing the response back to the requester.`}),(0,k.jsx)(`p`,{children:`Common features include rate limiting, authentication/authorization, request routing, and metrics collection.`})]}),(0,k.jsxs)(j,{id:`sd-net-cdn`,title:`4.3 Content Delivery Networks (CDNs)`,children:[(0,k.jsx)(`p`,{children:`A CDN is a geographically distributed network of proxy servers and their data centers. The goal is to provide high availability and performance by distributing the service spatially relative to end-users.`}),(0,k.jsx)(`p`,{children:`CDNs cache static content (HTML, CSS, JS, images, videos) closer to the user. When a user requests content, it's served from the nearest CDN Edge Server (Point of Presence or PoP) rather than the Origin Server.`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Push CDN:`}),` You upload content to the CDN, which is then responsible for providing it to users. Good for small traffic or content that rarely changes.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Pull CDN:`}),` CDN pulls content from the Origin server upon the first request and caches it. Good for heavy traffic.`]})]})]})]})}function Ti(){return(0,k.jsxs)(A,{id:`sd-chapter-5`,number:`5`,title:`System Design Interviews`,theme:`purple`,children:[(0,k.jsxs)(j,{id:`sd-int-framework`,title:`5.1 Interview Framework (PEDALS)`,children:[(0,k.jsxs)(`p`,{children:[`Approaching a system design interview requires a structured method. The `,(0,k.jsx)(`strong`,{children:`PEDALS`}),` framework is a popular approach:`]}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`P - Process Requirements:`}),` Clarify functional (what the system should do) and non-functional (scale, availability, latency) requirements.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`E - Estimate:`}),` Back-of-the-envelope calculations for traffic (QPS), storage, bandwidth, and memory.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`D - Design High-Level:`}),` Draw the core components (Client, Load Balancer, Web Servers, Database) and data flow.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`A - API Design:`}),` Define the REST endpoints or RPC calls between client and server.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`L - Logical Database Schema:`}),` Define the tables, NoSQL collections, and relationships.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`S - Scale & Deep Dive:`}),` Identify bottlenecks, add caching, sharding, message queues, and discuss trade-offs.`]})]})]}),(0,k.jsxs)(j,{id:`sd-int-url-shortener`,title:`5.2 Design a URL Shortener`,children:[(0,k.jsxs)(`p`,{children:[(0,k.jsx)(`strong`,{children:`Problem:`}),` Design a service like TinyURL that takes a long URL and generates a short, unique alias.`]}),(0,k.jsx)(`h4`,{children:`Key Considerations:`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Shortening Algorithm:`}),` Base62 encoding (A-Z, a-z, 0-9) of a unique ID. A 7-character Base62 string can support ~3.5 trillion URLs.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Unique ID Generation:`}),` Can't rely on auto-incrementing DB IDs at scale. Use a dedicated service like Twitter Snowflake or pre-generate IDs in blocks (ZooKeeper).`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Redirection:`}),` HTTP 301 (Permanent - browsers cache it) vs HTTP 302 (Temporary - better for analytics tracking).`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Database:`}),` NoSQL (like DynamoDB or Cassandra) is a good fit as the schema is simple (ShortURL, LongURL, UserID, CreationDate) and read-heavy.`]})]})]}),(0,k.jsxs)(j,{id:`sd-int-chat-app`,title:`5.3 Design a Chat Application`,children:[(0,k.jsxs)(`p`,{children:[(0,k.jsx)(`strong`,{children:`Problem:`}),` Design a real-time chat application like WhatsApp or Discord.`]}),(0,k.jsx)(`h4`,{children:`Key Considerations:`}),(0,k.jsxs)(`ul`,{children:[(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Real-Time Communication:`}),` WebSockets are essential for persistent, bi-directional connections between clients and servers. Polling or Long-Polling are inefficient fallbacks.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Connection Management:`}),` Need a "Gateway" or "Chat Servers" to maintain WebSocket connections. A separate "Session Server" (using Redis) tracks which user is connected to which Chat Server.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Message Routing:`}),` When User A sends a message to User B, Chat Server A checks the Session Server for User B's location, and routes the message (often via a message queue or pub/sub like Redis Pub/Sub) to Chat Server B.`]}),(0,k.jsxs)(`li`,{children:[(0,k.jsx)(`strong`,{children:`Storage:`}),` Need high write throughput. Cassandra or HBase are common for storing message histories.`]})]})]})]})}function Ei(){return(0,k.jsxs)(gr,{chapters:rr,brand:{title:`System Design`,icon:`systemdesign`,gradient:`linear-gradient(90deg, #8b5cf6, #c084fc)`,themeColor:`purple`},children:[(0,k.jsx)(xr,{chapters:rr,config:{badge:`Architect & Engineer`,title:`System Design`,subtitle:`Learn how to architect large-scale distributed systems`,description:`Master the fundamentals of scalability, databases, microservices, and prepare for system design interviews.`,meta:[`Architecture`,`Scalability`,`Databases`,`Interviews`],accent:`purple`,firstChapterId:`sd-chapter-1`}}),(0,k.jsx)(Sr,{chapters:rr}),(0,k.jsx)(xi,{}),(0,k.jsx)(Si,{}),(0,k.jsx)(Ci,{}),(0,k.jsx)(wi,{}),(0,k.jsx)(Ti,{}),(0,k.jsx)(Cr,{chapters:rr,trackName:`System Design Guide`})]})}function Di(){return(0,k.jsxs)(Gt,{children:[(0,k.jsx)(Ut,{path:`/`,element:(0,k.jsx)(dr,{})}),(0,k.jsx)(Ut,{path:`/frontend`,element:(0,k.jsx)(Yr,{})}),(0,k.jsx)(Ut,{path:`/backend`,element:(0,k.jsx)(ui,{})}),(0,k.jsx)(Ut,{path:`/devops`,element:(0,k.jsx)(bi,{})}),(0,k.jsx)(Ut,{path:`/system-design`,element:(0,k.jsx)(Ei,{})})]})}(0,$n.createRoot)(document.getElementById(`root`)).render((0,k.jsx)(x.StrictMode,{children:(0,k.jsx)(Nn,{children:(0,k.jsx)(Di,{})})}));